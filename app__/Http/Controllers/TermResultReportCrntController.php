...
class TermResultReportCrntController extends Controller {

    private $controller = 'TermResultReportCrnt';
...
//            echo '<pre>';
//            print_r($eventMksWtArr['avg_marking']);
//            exit;
...
//            exit;
        ...
        if ($request->view == 'print') {
            return view('reportCrnt.termResult.print.index')->with(compact('activeTrainingYearList', 'courseList', 'termList'
                                    , 'sortByList', 'assignedObsnInfo', 'gradeInfo'
                                    , 'eventMksWtArr', 'cmArr', 'rowSpanArr', 'achieveMksWtArr', 'assignedDsObsnInfo'));
        } elseif ($request->view == 'pdf') {
            $pdf = PDF::loadView('reportCrnt.termResult.print.index', compact('activeTrainingYearList', 'courseList', 'termList'
                                    , 'sortByList', 'assignedObsnInfo', 'gradeInfo'
                                    , 'eventMksWtArr', 'cmArr', 'rowSpanArr', 'achieveMksWtArr', 'assignedDsObsnInfo'))
            ...
            return Excel::download(new ExcelExport('reportCrnt.termResult.print.index', compact('activeTrainingYearList', 'courseList', 'termList'
                                            , 'sortByList', 'assignedObsnInfo', 'gradeInfo'
                                            , 'eventMksWtArr', 'cmArr', 'rowSpanArr', 'achieveMksWtArr', 'assignedDsObsnInfo')), $fileName . '.xlsx');
        }

        return view('reportCrnt.termResult.index', compact('activeTrainingYearList', 'courseList', 'termList'
                        , 'sortByList', 'assignedObsnInfo', 'gradeInfo'
                        , 'eventMksWtArr', 'cmArr', 'rowSpanArr', 'achieveMksWtArr', 'assignedDsObsnInfo'));
    }
    ...
    public function getCourse(Request $request) {
        ...
        $html = view('reportCrnt.termResult.getCourse', compact('courseList'))->render();
    ...
    public function getTerm(Request $request) {
        ...
        $html = view('reportCrnt.termResult.getTerm', compact('termList'))->render();
    ...
    public function filter(Request $request) {
        ...
        if ($validator->fails()) {
            return redirect('termResultReportCrnt?generate=false&' . $url)
                            ->withInput()
                            ->withErrors($validator);
        }
        return redirect('termResultReportCrnt?generate=true&' . $url);
    }
