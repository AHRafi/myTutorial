...
class CommissioningCourseWisePerformanceTrendReportController extends Controller {

    private $controller = 'CommissioningCourseWisePerformanceTrendReport';
    ...
    public function index(Request $request) {
        ...
        return view('report.commissioningCourseWisePerformanceTrend.index', compact('activeTrainingYearList'
    ...
    public function getCourse(Request $request) {
        $courseList = ['0' => __('label.SELECT_COURSE_OPT')] + Course::where('training_year_id', $request->training_year_id)
                        ...
                        ->pluck('name', 'id')
                        ->toArray();
        $html = view('report.commissioningCourseWisePerformanceTrend.getCourse', compact('courseList'))->render();
    ...
    public function getCourseWiseCommissioningCourse(Request $request) {
        ...
        $showCommissioningCourseView = view('report.commissioningCourseWisePerformanceTrend.getCourseWiseCommissioningCourse', compact('commissioningCourseList'))->render();
    ...
    public function filter(Request $request) {
        ...
        if ($validator->fails()) {
            return redirect('commissioningCourseWisePerformanceTrendReport?generate=false&' . $url)
                            ->withInput()
                            ->withErrors($validator);
        }
        return redirect('commissioningCourseWisePerformanceTrendReport?generate=true&' . $url);
    }
