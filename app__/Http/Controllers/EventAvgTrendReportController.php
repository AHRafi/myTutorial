...
class EventAvgTrendReportController extends Controller {

    private $controller = 'EventAvgTrendReport';
    ...
    public function index(Request $request) {
        ...
        $cmArr = CmBasicProfile::where('cm_basic_profile.course_id', $request->course_id)
...
//            exit;
        ...
        return view('report.eventAvgTrend.index', compact('activeTrainingYearList', 'courseList', 'termList'
    ...
    public function getCourse(Request $request) {
        ...
        $html = view('report.eventAvgTrend.getCourse', compact('courseList'))->render();
        $html2 = view('report.eventAvgTrend.getTerm', compact('termList'))->render();
    ...
    public function getTerm(Request $request) {
        ...
        $eventList = TermToEvent::join('event', 'event.id', '=', 'term_to_event.event_id')
                    ...
                    ->pluck('event.event_code', 'event.id')
                    ->toArray();
        $html = view('report.eventAvgTrend.getTerm', compact('termList'))->render();
        $showEventView = view('report.eventAvgTrend.getCourseWiseEvent', compact('eventList'))->render();
    ...
    public function filter(Request $request) {
        ...
        if ($validator->fails()) {
            return redirect('eventAvgTrendReport?generate=false&' . $url)
                            ->withInput()
                            ->withErrors($validator);
        }
        return redirect('eventAvgTrendReport?generate=true&' . $url);
    }
