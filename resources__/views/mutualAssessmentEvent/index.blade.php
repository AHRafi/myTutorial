...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            ...
            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('mutualAssessmentFactor/create'.Helper::queryPageStr($qpArr)) }}"> @lang('label.CREATE_NEW_MUTUAL_ASSESSMENT_EVENT')
        ...
        <div class="portlet-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <!-- Begin Filter-->
                    {!! Form::open(array('group' => 'form', 'url' => 'mutualAssessmentFactor/filter','class' => 'form-horizontal')) !!}
                    <div class="row">
                        ...
                        <tr>
                            ...
                            <td class="td-actions vcenter text-center">
                                <div class="width-inherit">
                                    {{ Form::open(array('url' => 'mutualAssessmentFactor/' . $target->id.Helper::queryPageStr($qpArr))) }}
                                    {{ Form::hidden('_method', 'DELETE') }}

                                    <a class="btn btn-xs btn-primary tooltips " title="Edit" href="{{ URL::to('mutualAssessmentFactor/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">
