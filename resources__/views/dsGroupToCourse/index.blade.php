                    ...
                    <div id="showDsGroup">
                        ...
                        <div class = "form-group">
                            ...
                            <div class = "col-md-4 margin-top-8">
                                ...
                                //disable
                                $disabledCAll = '';
                                if (!empty($dsGroupTemplateDataArr)) {
                                ...
                                <div class="form-group form-md-line-input table-responsive max-height-300 webkit-scrollbar">
                                    <div class="col-md-10">
                                        <div class="md-checkbox-list">
                                            ...
                                            $disabled = '';
                                            if (!empty($dsGroupTemplateDataArr)) {
                                                $disabled = in_array($item->id, $dsGroupTemplateDataArr) ? 'disabled' : '';
                                            }
                                            $checked = '';
                                            ...
                                            if (!empty($previousDataList[$item->id])) {
                                                if (in_array($previousDataList[$item->id], $previousDataList)) {
                                                    $checked = 'checked';
                                                    $groupNmae = $item->name;
                                                    if (in_array($item->id, $dsGroupTemplateDataArr)) {
                                                        $title = __('label.DS_IS_ALREADY_ASSIGNED_TO_GROUP', ['groupName' => $groupNmae]);
                                                    }  else {
                                            ...
                                            <div class="md-checkbox">
                                                ...
                                                @endif
                                                @if(!empty($disabled))
                                                {!! Form::hidden('ds_group_id['.$item->id.']', $item->id) !!}
                                                @endif
