                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="col-md-7"> <div class="control-label pull-left"> <strong> {{$activeCourse->name}} </strong></div>
...
//delete
        $(document).on('click', '#buttonDelete', function (e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url: "{{URL::to('eventAssessmentMarking/deleteEventAssessmentMarking')}}",
                        type: "POST",
                        datatype: 'json',
                        cache: false,
                        contentType: false,
