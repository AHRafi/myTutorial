            ...
            <div class="row margin-top-10">
                <div class="col-md-12">
                    <div class="text-center bold uppercase">
                        <span class="header">@lang('label.BASIC_INFORMATION_WISE_CM_ANALYTICS')</span>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="bg-blue-hoki bg-font-blue-hoki">
                        <h5 style="padding: 10px;">
                            {{__('label.NAME')}} : <strong>{{ !empty(Request::get('name')) && Request::get('name') != '' ? Request::get('name') : __('label.ALL') }} |</strong>
                    ...
                    <table class="table table-bordered table-hover table-head-fixer-color" id="dataTable">
                        <thead>
                            <tr>
                                ...
                                <th class="vcenter text-center">@lang('label.FULL_NAME_BANGLA')</th>
                                @endif
        ...
        <table class="no-border margin-top-10">
            ...
            <tr>
                <td class="no-border text-center" colspan="8">
                    <strong>{!!__('label.BASIC_INFORMATION_WISE_CM_ANALYTICS')!!}</strong>
                </td>
            </tr>
        </table>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    @endif
                    @if(empty($columns) || in_array('7', $columns))
                    <th class="vcenter text-center">@lang('label.RELIGION')</th>
                    @endif
                    @if(empty($columns) || in_array('8', $columns))
                    <th class="vcenter text-center">@lang('label.GENDER')</th>
                    @endif
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    @endif
                    @if(empty($columns) || in_array('4', $columns))
                    <td class="vcenter">{!! Common::getFormattedPhoneNumber($target['number']) !!}</td>
                    @endif
                    @if(empty($columns) || in_array('5', $columns))
                    <td class="vcenter text-center">{!! !empty($target['blood_group']) && !empty($bloodGroupList[$target['blood_group']]) ? $bloodGroupList[$target['blood_group']] : '' !!}</td>
                    @endif
