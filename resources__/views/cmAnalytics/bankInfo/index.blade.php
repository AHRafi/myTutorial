...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.BANK_INFORMATION_WISE_CM_ANALYTICS')
            </div>
        </div>
        ...
        <div class="portlet-body">
            <!-- Begin Filter-->
            {!! Form::open(array('group' => 'form', 'url' => 'bankInfoWiseCmAnalytics/filter','class' => 'form-horizontal')) !!}
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-12">
                    <div class="bg-blue-hoki bg-font-blue-hoki">
                        <h5 style="padding: 10px;">
                            ...
                            {{__('label.ONLINE')}} : <strong>{{ !empty(Request::get('online_check')) && Request::get('online_check') != '' ? Request::get('online_check') : __('label.N_A') }} |</strong>
