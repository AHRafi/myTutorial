...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.MIL_QUAL_WISE_CM_ANALYTICS')
            </div>
        </div>

        <div class="portlet-body">
            <!-- Begin Filter-->
            {!! Form::open(array('group' => 'form', 'url' => 'milQualWiseCmAnalytics/filter','class' => 'form-horizontal')) !!}
            <div class="row">
                <div class="col-md-4">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {!! Form::select('mil_course_id[]', $milCourseList, !empty(Request::get('mil_course_id'))?explode(',',Request::get('mil_course_id')):'' , [ 'id' => 'milCourseId', 'class' => 'form-control mt-multiselect btn btn-default',  'multiple' , 'data-select-all'=>"true", 'data-width' => '100%']) !!}
                        </div>
                    </div>
                </div>
            </div>
...
//        enableFiltering: true,
        ...
        var milCourseAllSelected = false;
        $('#milCourseId').multiselect({
            numberDisplayed: 0,
            includeSelectAllOption: true,
            buttonWidth: '100%',
            maxWidth: 50,
            maxHeight: 250,
            nonSelectedText: "@lang('label.SELECT_MIL_COURSE')",
//        enableFiltering: true,
            enableCaseInsensitiveFiltering: true,
            onSelectAll: function () {
                milCourseAllSelected = true;
            },
            onChange: function () {
                milCourseAllSelected = false;
            }
        });
