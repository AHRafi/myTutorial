...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-clipboard"></i>@lang('label.CREATE_NOTICE')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::open(array('group' => 'form', 'url' => 'noticeBoard', 'files'=> true, 'class' => 'form-horizontal')) !!}
                        ...
                        <div class = "form-group">
                            ...
                            <div class="col-md-8">
                                <div class="input-group date datepicker2">
                                    {!! Form::text('end_date', null, ['id'=> 'date', 'class' => 'form-control', 'placeholder' => 'DD/MM/YYYY', 'readonly' => '']) !!} 
