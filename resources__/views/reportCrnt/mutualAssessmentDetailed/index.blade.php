...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        ...
        <div class="portlet-body">
            {!! Form::open(array('group' => 'form', 'url' => 'mutualAssessmentDetailedReportCrnt/filter','class' => 'form-horizontal', 'id' => 'submitForm')) !!}
            <div class="row">
                <div class="col-md-2">
                        ...
                        <table class="table table-bordered table-hover table-head-fixer-color" id="dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="5">
                                        <strong>
                                            @if(Request::get('ma_process') == '1')
                                            @lang('label.NO_CM_IS_ASSIGNED_TO_THIS_SYNDICATE')
                                            @elseif(Request::get('ma_process') == '2')
                                            @lang('label.NO_CM_IS_ASSIGNED_TO_THIS_SUB_SYNDICATE')
                                            @elseif(Request::get('ma_process') == '3')
    ...
    $(function () {
        ...
        $(document).on("change", "#trainingYearId", function () {
            ...
            if (trainingYearId == 0) {
                ...
                $('#factorId').html("<option value='0'>@lang('label.SELECT_EVENT_OPT')</option>");
                if (maProcess == 0) {
            ...
            $.ajax({
                url: "{{ URL::to('mutualAssessmentDetailedReportCrnt/getCourse')}}",
                type: "POST",
                dataType: "json",
                headers: {
        ...
        $(document).on("change", "#courseId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('mutualAssessmentDetailedReportCrnt/getTerm')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("change", "#termId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('mutualAssessmentDetailedReportCrnt/getSynOrGp')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("change", "#eventId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('mutualAssessmentDetailedReportCrnt/getSubEvent')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("change", "#subEventId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('mutualAssessmentDetailedReportCrnt/getSubSubEvent')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("change", "#subSubEventId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('mutualAssessmentDetailedReportCrnt/getSubSubSubEvent')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("change", "#subSubSubEventId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('mutualAssessmentDetailedReportCrnt/getEventGroup')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
