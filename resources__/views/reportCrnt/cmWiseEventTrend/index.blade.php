...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        ...
        <div class="portlet-body">
            {!! Form::open(array('group' => 'form', 'url' => 'cmWiseEventTrendReportCrnt/filter','class' => 'form-horizontal', 'id' => 'submitForm')) !!}
            <div class="row">
                <div class="col-md-2">
...
//START::Get Course
    $(document).on("change", "#trainingYearId", function () {
        ...
        $.ajax({
            url: "{{ URL::to('cmWiseEventTrendReportCrnt/getCourse')}}",
            type: "POST",
            dataType: "json",
            headers: {
...
//START::Get Svc Wise Cm
    $(document).on("change", "#wingId", function () {
        ...
        $.ajax({
            url: "{{ URL::to('cmWiseEventTrendReportCrnt/getCm')}}",
            type: "POST",
            dataType: "json",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
//START::Get Course Wise Cm & Event
    $(document).on("change", "#courseId", function () {
        var courseId = $("#courseId").val();
        $.ajax({
            url: "{{ URL::to('cmWiseEventTrendReportCrnt/getTerm')}}",
            type: "POST",
            dataType: "json",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    ...
    $(document).on("change", "#termId", function () {
        ...
        $.ajax({
            url: "{{ URL::to('cmWiseEventTrendReportCrnt/getCourseWiseCmEvent')}}",
            type: "POST",
            dataType: "json",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
