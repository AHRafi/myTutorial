...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        ...
        <div class="portlet-body">
            {!! Form::open(array('group' => 'form', 'url' => 'dsMarkingTrendReportCrnt/filter','class' => 'form-horizontal', 'id' => 'submitForm')) !!}
            <div class="row">
                <div class="col-md-2">
...
//START::Get Course Wise Ds & Event
    $(document).on("change", "#termId", function () {
        ...
        $.ajax({
            url: "{{ URL::to('dsMarkingTrendReportCrnt/getCourseWiseDsEvent')}}",
            type: "POST",
            dataType: "json",
            headers: {
...
//               //Start:: Multiselect Ds
    ...
    $(document).on("change", "#eventId", function () {
        ...
        $.ajax({
            url: "{{ URL::to('dsMarkingTrendReportCrnt/getCourseWiseDsSubEvent')}}",
            type: "POST",
            dataType: "json",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    ...
    $(document).on("change", "#subEventId", function () {
        ...
        $.ajax({
            url: "{{ URL::to('dsMarkingTrendReportCrnt/getCourseWiseDsSubSubEvent')}}",
            type: "POST",
            dataType: "json",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    ...
    $(document).on("change", "#subSubEventId", function () {
        ...
        $.ajax({
            url: "{{ URL::to('dsMarkingTrendReportCrnt/getCourseWiseDsSubSubSubEvent')}}",
            type: "POST",
            dataType: "json",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    ...
    $(document).on("change", "#subSubSubEventId", function () {
        ...
        $.ajax({
            url: "{{ URL::to('dsMarkingTrendReportCrnt/getCourseWiseDs')}}",
            type: "POST",
            dataType: "json",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
