...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        ...
        <div class="portlet-body">
            <!-- Begin Filter-->
            {!! Form::open(array('group' => 'form', 'url' => 'celebrationDsAnalytics/filter','class' => 'form-horizontal')) !!}
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-12">
                    <div class="webkit-scrollbar table-responsive {{(!empty(Request::get('month')) && Request::get('month') != '00') ? '' : 'max-height-500'}}">
                        <table class="table table-bordered table-hover table-head-fixer-color" id="dataTable">
                            ...
                            <tbody>
                                <?php
                                $rowspan = in_array(Request::get('cel_event'), ['1', '3']) ? 7 : (Request::get('cel_event') == '2' ? 8 : 6);
                                ?>
                                @if(!empty(Request::get('month')) && Request::get('month') != '00')
                                <tr class="active">
                                    <td class="vcenter text-center bold" colspan="{!! $rowspan !!}">@lang('label.THIS_MONTH')</td>
                                </tr>
                                ...
                                @else
                                <tr>
                                    <td colspan="{!! $rowspan !!}">@lang('label.NO_DS_FOUND')</td>
                                </tr>
                                @endif
                                <tr class="active">
                                    <td class="vcenter text-center bold" colspan="{!! $rowspan !!}">@lang('label.NEXT_MONTH')</td>
                                </tr>
                                ...
                                @endif
                                <tr class="active">
                                    <td class="vcenter text-center bold" colspan="{!! $rowspan !!}">@lang('label.PREVIOUS_MONTH')</td>
                                </tr>
...
<script type="text/javascript">
    $(function () {
        ...
        $(document).on("change", "#month", function () {
            ...
            $.ajax({
                url: "{{ URL::to('celebrationDsAnalytics/getmonthDayList')}}",
                type: "POST",
                dataType: "json",
                headers: {
