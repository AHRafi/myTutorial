            ...
            <div class="row margin-top-10">
                <div class="col-md-12">
                    <div class="text-center bold uppercase">
                        <span class="header">@lang('label.MIL_QUAL_WISE_DS_ANALYTICS')</span>
                    </div>
                </div>
            </div>
            <div class="row margin-top-10">
                    ...
                    <table class="table table-bordered table-hover table-head-fixer-color" id="dataTable">
                        <thead>
                             <tr>
                                ...
                                <th class="vcenter">@lang('label.INSTITUTE_N_COUNTRY')</th>
                                @endif
                            ...
                            @foreach($targetArr as $id => $target)
                               ...
                               <tr>
                                <td class="vcenter text-center" rowspan="{{!empty($target['rec_svc_span']) ? $target['rec_svc_span'] : 1}}">
                                 ...
                                 <td class="vcenter" rowspan="{{!empty($target['rec_svc_span']) ? $target['rec_svc_span'] : 1}}">{!! Common::getFurnishedCmName($target['personal_no']) !!}</td>
                    <td class="vcenter" rowspan="{{!empty($target['rec_svc_span']) ? $target['rec_svc_span'] : 1}}">{!! Common::getFurnishedCmName($target['rank']) !!}</td>
                    <td class="vcenter" rowspan="{{!empty($target['rec_svc_span']) ? $target['rec_svc_span'] : 1}}">{!! Common::getFurnishedCmName($target['full_name']) !!}</td>
                                @if(empty($columns) || in_array('1', $columns))
        ...
        <table class="no-border margin-top-10">
            ...
            <tr>
                <td class="no-border text-center" colspan="8">
                    <strong>{!!__('label.MIL_QUAL_WISE_DS_ANALYTICS')!!}</strong>
                </td>
            </tr>
        </table>
        <table class="no-border margin-top-10">
                ...
                @foreach($targetArr as $id => $target)
                  ...
                  <tr>
                    ...
                    <td class="vcenter" rowspan="{{!empty($target['rec_svc_span']) ? $target['rec_svc_span'] : 1}}">{!! Common::getFurnishedCmName($target['full_name']) !!}</td>
                                ...
                                ?>
                                @if(empty($columns) || in_array('3', $columns))
                                <td class="vcenter"> {!! !empty($rsInfo['institute_name']) ? Common::getFormattedAmp($rsInfo['institute_name']) : '' !!}</td>
                                @endif
                                @if(empty($columns) || in_array('4', $columns))
                                <td class="vcenter"> {!! !empty($rsInfo['course']) ? Common::getFormattedAmp($rsInfo['course']) : '' !!}</td>
                                @endif
                                @if(empty($columns) || in_array('5', $columns))
                                <td class="vcenter">{!! $rsInfo['result'] ?? '' !!}</td>
                                @endif
