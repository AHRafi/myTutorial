            ...
            <div class="row margin-top-10">
                <div class="col-md-12">
                    <div class="text-center bold uppercase">
                        <span class="header">@lang('label.COMMISSIONING_COURSE_WISE_DS_ANALYTICS')</span>
                    </div>
                </div>
            </div>
            <div class="row margin-top-10">
                    ...
                    <table class="table table-bordered table-hover table-head-fixer-color" id="dataTable">
                        <thead>
                            <tr>
                                ...
                                <th class="vcenter">@lang('label.JOINING_DATE')</th>
                                @endif
        ...
        <table class="no-border margin-top-10">
            ...
            <tr>
                <td class="no-border text-center" colspan="8">
                    <strong>{!!__('label.COMMISSIONING_COURSE_WISE_DS_ANALYTICS')!!}</strong>
                </td>
            </tr>
        </table>
        <table class="no-border margin-top-10">
