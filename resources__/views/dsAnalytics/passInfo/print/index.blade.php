            ...
            <div class="row margin-top-10">
                <div class="col-md-12">
                    <div class="text-center bold uppercase">
                        <span class="header">@lang('label.PASSPORT_INFORMATION_WISE_DS_ANALYTICS')</span>
                    </div>
                </div>
            </div>
            <div class="row margin-top-10">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="vcenter text-center" width="50px">
                                    ...
                                    <img class="profile-zoom" width="50" height="60" src="{{URL::to('/')}}/public/uploads/cmPassPhoto/{{$target['photo_without_uniform']}}" alt="{{$target['official_name']?? ''}}"/>
                                    @else
                                    <img class="profile-zoom" width="50" height="60" src="{{URL::to('/')}}/public/img/unknown.png" alt="{{$target['official_name']?? ''}}"/>
                                    @endif
                                </td>
        ...
        <table class="no-border margin-top-10">
            ...
            <tr>
                <td class="no-border text-center" colspan="8">
                    <strong>{!!__('label.PASSPORT_INFORMATION_WISE_DS_ANALYTICS')!!}</strong>
                </td>
            </tr>
        </table>
        <table class="no-border margin-top-10">
