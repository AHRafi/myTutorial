...
<html lang="en">
    <head>
        ...
        <link href="{{asset('public/css/apexcharts.css')}}" rel="stylesheet" type="text/css"/>
        ...
        <!--        Summer Note CSS         -->
        <link href="{{asset('public/assets/global/plugins/summer-note/summernote.min.css')}}" rel="stylesheet" type="text/css" />
        <!--        END Summer Note CSS         -->
