    ...
    <div class="col-md-12">
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-line-chart"></i>@lang('label.EDIT_LESSON')
                </div>
            </div>
            <div class="portlet-body form">
                {!! Form::model($target, [
                    'route' => ['lesson.update', $target->id],
                    'method' => 'PATCH',
                    'files' => true,
                    ...
                    <div class="row">
                        <div class="col-md-offset-1 col-md-7">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4" for="name">@lang('label.LESSON_TITLE') :<span
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group date datepicker2">
                                        {!! Form::text('eval_date', !empty($target->eval_date) ? Helper::formatDate($target->eval_date) : null, [
                                            'class' => 'form-control',
                                            'id' => 'dobFrom',
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group date datepicker2">
                                        {!! Form::text(
                                            'eval_deadline',
                                            !empty($target->eval_deadline) ? Helper::formatDate($target->eval_deadline) : null,
                                            ['class' => 'form-control', 'id' => 'dobFrom', 'placeholder' => 'DD/MM/YYYY', 'readonly' => ''],
                                        ) !!}
                                        <span class="input-group-btn">
                                            <button class="btn default reset-date" type="button" remove="dobFrom">
                                                <i class="fa fa-times"></i>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    {!! Form::select('status', ['1' => __('label.ACTIVE'), '2' => __('label.INACTIVE')], null, [
                                        'class' => 'form-control',
                                        'id' => 'status',
                                    ]) !!}
