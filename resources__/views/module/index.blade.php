...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            ...
            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('module/create'.Helper::queryPageStr($qpArr)) }}"> @lang('label.CREATE_NEW_MODULE')
        ...
        <div class="portlet-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <!-- Begin Filter-->
                    {!! Form::open(array('group' => 'form', 'url' => 'module/filter','class' => 'form-horizontal')) !!}
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    {!! Form::text('fil_search',  Request::get('fil_search'), ['class' => 'form-control tooltips', 'id' => 'filSearch', 'title' => 'Name', 'placeholder' => 'Name', 'list' => 'moduleName', 'autocomplete' => 'off']) !!} 
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="td-actions vcenter text-center">
                                <div class="width-inherit">
                                    {{ Form::open(array('url' => 'module/' . $target->id.Helper::queryPageStr($qpArr))) }}
                                    {{ Form::hidden('_method', 'DELETE') }}

                                    <a class="btn btn-xs btn-primary tooltips " title="Edit" href="{{ URL::to('module/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">
                        ...
                        @else
                        <tr>
                            <td colspan="7" class="vcenter">@lang('label.NO_MODULE_FOUND')</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
