                        ...
                        <div class="col-md-5">
                            ...
                            <div class="table-responsive webkit-scrollbar">
                                <table class="table table-bordered table-hover table-head-fixer-color" id="dataTable">
                                    <thead>
                                        <tr>
                                            <th class="text-center vcenter" colspan="3">@lang('label.CI_OBSN_INFO')</th>
                                        </tr>
                                        <tr>
                                    ...
                                    <tbody>
                                        <?php
                                        $obsnAlign = !empty($assignedObsnInfo->ci_obsn_wt) ? 'right' : 'center';
                                        $mksLimitAlign = !empty($assignedObsnLimitInfo->ci_mks_limit) ? 'right' : 'center';
                                        $limitPercentAlign = !empty($assignedObsnLimitInfo->ci_limit_percent) ? 'right' : 'center';
                                        ?>
                                        <tr>
                                            <td class="vcenter text-{{$mksLimitAlign}} width-80">{!! !empty($assignedObsnLimitInfo->ci_mks_limit) ? Helper::numberFormat2Digit($assignedObsnLimitInfo->ci_mks_limit) : '--' !!}</td>
                                            <td class="vcenter text-{{$limitPercentAlign}} width-80">{!! !empty($assignedObsnLimitInfo->ci_limit_percent) ? '&plusmn'.Helper::numberFormat2Digit($assignedObsnLimitInfo->ci_limit_percent).'%' : '--' !!}</td>
                                            <td class="vcenter text-{{$obsnAlign}} width-80">{!! !empty($assignedObsnInfo->ci_obsn_wt) ? Helper::numberFormat2Digit($assignedObsnInfo->ci_obsn_wt) : '--' !!}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                    ...
                                    <table class="table table-bordered table-hover table-head-fixer-color">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th class="vcenter text-center">@lang('label.POSITION')</th>
                                                <?php
                                                $mksLimit = !empty($assignedObsnLimitInfo->ci_mks_limit) ? $assignedObsnLimitInfo->ci_mks_limit : 0;
                                                $limitPercent = !empty($assignedObsnLimitInfo->ci_limit_percent) ? $assignedObsnLimitInfo->ci_limit_percent : 0;
                                                ?>
...
//                    $synName = (!empty($cmInfo['syn_name']) ? $cmInfo['syn_name'] . ' ' : '') . (!empty($cmInfo['sub_syn_name']) ? '(' . $cmInfo['sub_syn_name'] . ')' : '');
                                            ...
                                            <tr>
                                                ...
                                                ?>
                                                <td class="text-{{$totalAssignedWtTextAlign}} vcenter width-80">
                                                    <span class="form-control integer-decimal-only width-inherit text-right">{!! !empty($cmInfo['agg_total_wt_limit']) ? Helper::numberFormatDigit2($cmInfo['agg_total_wt_limit']) : '' !!}</span>
                                                    {!! Form::hidden('wt['.$cmId.'][total_term_assigned]',!empty($cmInfo['agg_total_wt_limit']) ? $cmInfo['agg_total_wt_limit'] : null,['id' => 'totalTermAssignedWt_'.$cmId, 'data-key' => $cmId, 'class' => 'form-control integer-decimal-only width-inherit text-right total-percent','autocomplete'=>'off']) !!} 
                                                </td>
                                                <td class="text-{{$totalWtTextAlign}} vcenter width-80">
                                                    <span class="form-control integer-decimal-only width-inherit text-right total-term-wt">{!! !empty($cmInfo['term_agg_total_wt']) ? Helper::numberFormatDigit2($cmInfo['term_agg_total_wt']) : '' !!}</span>
                                                    {!! Form::hidden('wt['.$cmId.'][total_term_wt]',!empty($cmInfo['term_agg_total_wt']) ? $cmInfo['term_agg_total_wt'] : null,['id' => 'totalTermWt_'.$cmId, 'data-key' => $cmId, 'class' => 'form-control integer-decimal-only width-inherit text-right total-percent','autocomplete'=>'off']) !!} 
                                                </td>
                                                <td class="text-{{$totalPercentageTextAlign}} vcenter width-80">
                                                    ...
                                                    {!! Form::hidden('wt['.$cmId.'][total_percent]',!empty($cmInfo['term_agg_percentage']) ? $cmInfo['term_agg_percentage'] : null,['id' => 'totalPercent_'.$cmId, 'data-key' => $cmId, 'class' => 'form-control integer-decimal-only width-inherit text-right total-percent','autocomplete'=>'off']) !!} 
                                                </td>
                                                <?php
                                                $totalPercent = !empty($cmInfo['term_agg_percentage']) ? $cmInfo['term_agg_percentage'] : 0;
                                                ...
                                                <!--start :: ci obsn-->
                                                <td class="vcenter width-80">
                                                    {!! Form::text('wt['.$cmId.'][ci_obsn_mks]',!empty($cmInfo['ci_obsn_mks']) ? Helper::numberFormatDigit3($cmInfo['ci_obsn_mks']) : null,['id' => 'ciObsnMksId_'.$cmId, 'data-key' => $cmId
                                                ...
                                                <td class="vcenter width-80">
                                                    <span id="ciObsnWt_{{$cmId}}" class="form-control integer-decimal-only width-inherit bold text-center">
                                                        {!! !empty($cmInfo['ci_obsn']) ? Helper::numberFormatDigit3($cmInfo['ci_obsn']) : null !!}
                                                    </span>
                                                    {!! Form::hidden('wt['.$cmId.'][ci_obsn]',!empty($cmInfo['ci_obsn']) ? $cmInfo['ci_obsn'] : null,['id' => 'ciObsnIdVal_'.$cmId, 'data-key' => $cmId, 'class' => 'form-control integer-decimal-only width-inherit text-right','readonly','autocomplete'=>'off']) !!} 
                                                </td>
                                                <td class="vcenter width-80">
                                                    <span id="afterCiWt_{{$cmId}}" class="form-control integer-decimal-only width-inherit bold text-center">
                                                        {!! !empty($cmInfo['after_ci_obsn']) ? Helper::numberFormatDigit3($cmInfo['after_ci_obsn']) : null !!}
                                                    </span>
                                                </td>
                                                <td class="vcenter width-80">
                                                    <span id="totalWt_{{$cmId}}" class="form-control integer-decimal-only width-inherit bold text-center">
                                                        {!! !empty($cmInfo['total_wt']) ? Helper::numberFormatDigit3($cmInfo['total_wt']) : null !!}
                                                    </span>
                                                    {!! Form::hidden('wt['.$cmId.'][total_wt]',!empty($cmInfo['total_wt']) ? $cmInfo['total_wt'] : null,['id' => 'totalWt_Val_'.$cmId, 'data-key' => $cmId, 'class' => 'form-control integer-decimal-only width-inherit text-right','readonly','autocomplete'=>'off']) !!} 
                                                </td>
                                                <td class="vcenter width-80">
                                                    {!! Form::text('wt['.$cmId.'][percentage]',!empty($cmInfo['percent']) ? Helper::numberFormatDigit3($cmInfo['percent']) : null,['id' => 'percentId_'.$cmId, 'data-key' => $cmId, 'class' => 'form-control integer-decimal-only width-inherit text-right','readonly','autocomplete'=>'off']) !!} 
                                                </td>
                                                <td class="vcenter width-80">
                            ...
                            <div class="col-md-12 margin-top-10">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="alert alert-danger alert-dismissable">
                                            <p><strong><i class="fa fa-unlock"></i> {!! __('label.REQUEST_FOR_UNLOCK') !!}</strong></p>
                                        </div>
                                    </div>
                                    @endif
                                    @else
...
$(function () {
    ...
    $(document).on('click', '.auto-fill', function (e) {
        $('.total-percent').each(function () {
            ...
            var assignedObsnMks = parseFloat($("#assignedMksId").val());
            var assignedObsnWt = parseFloat($("#assignedWtId").val());
            var assignedWt = parseFloat($("#totalTermAssignedWt_" + key).val());
            var afterTermWt = parseFloat($("#totalTermWt_" + key).val());
            var afterCiWt = parseFloat($("#afterCiWt_" + key).text());

            var givenWt = (givenMks * assignedObsnWt) / assignedObsnMks;
//        alert(givenWt);

            if (afterTermWt == '' || isNaN(afterTermWt)) {
                afterTermWt = 0;
            }

            afterCiWt = Number(assignedWt) + Number(assignedObsnWt);

            var wt = parseFloat(Number(afterTermWt) + Number(givenWt)).toFixed(3);
            var wtVal = parseFloat(Number(afterTermWt) + Number(givenWt)).toFixed(6);
            var wtPercent = parseFloat((wt / afterCiWt) * 100).toFixed(3);

            if ($(".auto-fill").prop("checked") == true && !isNaN(givenWt)) {
                $("#ciObsnMksId_" + key).val(parseFloat(givenMks).toFixed(3));
                $("#ciObsnIdVal_" + key).val(parseFloat(givenWt).toFixed(6));
                $("#ciObsnWt_" + key).text(parseFloat(givenWt).toFixed(3));
                $("#afterCiWt_" + key).text(parseFloat(afterCiWt).toFixed(3));
                ...
                $("#ciObsnMksId_" + key).val('');
                $("#ciObsnIdVal_" + key).val('');
                $("#ciObsnWt_" + key).text('');
                $("#afterCiWt_" + key).text(parseFloat(assignedWt).toFixed(3));
                $("#totalWt_" + key).text('');
    ...
    $(document).on("change", "#courseId", function () {
        ...
        $.ajax({
            url: "{{ URL::to('ciObsnMarking/showCmMarkingList')}}",
            type: "POST",
            dataType: "json",
            headers: {
    ...
    $(document).on("change", "#sortBy", function () {
        ...
        $.ajax({
            url: "{{ URL::to('ciObsnMarking/filter')}}",
            type: "POST",
            dataType: "json",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    ...
    $(document).on('click', '.button-submit', function (e) {
        ...
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    url: "{{URL::to('ciObsnMarking/saveObsnMarking')}}",
                    type: "POST",
                    datatype: 'json',
                    cache: false,
                    contentType: false,
...
//                            $("#courseId").trigger('change');
    ...
    $(document).on('click', '#buttonDelete', function (e) {
        ...
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    url: "{{URL::to('ciObsnMarking/clearMarking')}}",
                    type: "POST",
                    datatype: 'json',
                    cache: false,
                    contentType: false,
...
//Rquest for unlock
    $(document).on('click', '.request-for-unlock', function (e) {
        ...
        $.ajax({
            url: "{{URL::to('ciObsnMarking/getRequestForUnlockModal')}}",
            type: "POST",
            datatype: 'json',
            cache: false,
            contentType: false,
    ...
    $(document).on('click', '.save-request-for-unlock', function (e) {
        ...
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    url: "{{URL::to('ciObsnMarking/saveRequestForUnlock')}}",
                    type: "POST",
                    datatype: 'json',
                    cache: false,
                    contentType: false,
    ...
    $(document).on('click', '#courseStatusSummaryId', function (e) {
        ...
        var courseId = $("#courseId").val();
        $.ajax({
            url: "{{URL::to('ciObsnMarking/requestCourseSatatusSummary')}}",
            type: "POST",
            datatype: 'json',
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    ...
    $(document).on('click', '.ds-marking-status', function (e) {
        ...
        $.ajax({
            url: "{{URL::to('ciObsnMarking/getDsMarkingSummary')}}",
            type: "POST",
            datatype: 'json',
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
//table header fix
    ...
    $(document).on('keyup', '.given-wt', function () {
        ...
        var givenWt = (givenMks * assignedObsnWt) / assignedObsnMks;
        var highestWt = (highestMks * assignedObsnWt) / assignedObsnMks;
//        alert(givenWt);
    ...
    $(document).on('blur', '.given-wt', function () {
        ...
        var givenWt = (givenMks * assignedObsnWt) / assignedObsnMks;
        var lowestWt = (lowestMks * assignedObsnWt) / assignedObsnMks;
