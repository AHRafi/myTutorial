...
<div class="col-md-4">
    <div class="form-group">
        <label class="control-label col-md-5" for="synId">@lang('label.SYNDICATE') :<span class="text-danger"> *</span></label>
        <div class="col-md-7">
...
@endif
@endif
{!! Form::hidden('has_grouping', $hasGrouping, ['id' => 'hasGrouping']) !!}