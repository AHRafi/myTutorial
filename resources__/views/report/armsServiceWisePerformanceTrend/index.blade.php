...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        ...
        <div class="portlet-body">
            {!! Form::open(array('group' => 'form', 'url' => 'armsServiceWisePerformanceTrendReport/filter','class' => 'form-horizontal', 'id' => 'submitForm')) !!}
            <div class="row">
                <div class="col-md-4">
...
//START::Get Course
    $(document).on("change", "#trainingYearId", function () {
        ...
        $.ajax({
            url: "{{ URL::to('armsServiceWisePerformanceTrendReport/getCourse')}}",
            type: "POST",
            dataType: "json",
            headers: {
...
//START::Get Course Wise Arms Service & Event
    $(document).on("change", "#courseId", function () {
        ...
        $.ajax({
            url: "{{ URL::to('armsServiceWisePerformanceTrendReport/getCourseWiseArmsService')}}",
            type: "POST",
            dataType: "json",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
