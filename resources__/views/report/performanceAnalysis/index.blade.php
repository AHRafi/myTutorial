...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        ...
        <div class="portlet-body">
            {!! Form::open(array('group' => 'form', 'url' => 'performanceAnalysisReport/filter','class' => 'form-horizontal', 'id' => 'submitForm')) !!}
            <div class="row">
                <div class="col-md-4">
...
//        enableFiltering: true,
        ...
        $(document).on("change", "#trainingYearId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('performanceAnalysisReport/getCourse')}}",
                type: "POST",
                dataType: "json",
                headers: {
...
//        enableFiltering: true,
        ...
        $(document).on("change", "#courseId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('performanceAnalysisReport/getCm')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
