            ...
            <div class="row margin-top-10">
                <div class="col-md-12">
                    <div class="text-center bold uppercase">
                        <span class="header">@lang('label.EVENT_RESULT_COMBINED')</span>
                    </div>
                </div>
            </div>
            <div class="row margin-top-10">
                    ...
                    <table class="table table-bordered table-hover table-head-fixer-color">
                        <thead>
                            <tr>
                                ...
                                @endforeach
                                @endif
                                <th class="vcenter text-center" colspan="5" rowspan="4">@lang('label.EVENT_TOTAL')</th>
                                <th class="vcenter" rowspan="5">@lang('label.PERSONAL_NO')</th>
                                <th class="vcenter" rowspan="5">@lang('label.RANK')</th>
                                <th class="vcenter" rowspan="5">@lang('label.CM')</th>
                                <th class="vcenter" rowspan="5">@lang('label.PHOTO')</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-{{$mksTextAlign}} vcenter width-80">
                                    <span class="width-inherit bold">{!! !empty($achieveMksWtArr[$cmId][$eventId][$subEventId][$subSubEventId][$subSubSubEventId]['mks']) ? $achieveMksWtArr[$cmId][$eventId][$subEventId][$subSubEventId][$subSubSubEventId]['mks'] : '--' !!}</span>
                                </td>
                                <td class="text-{{$wtTextAlign}} vcenter width-80">
                                    <span class="width-inherit bold">{!! !empty($achieveMksWtArr[$cmId][$eventId][$subEventId][$subSubEventId][$subSubSubEventId]['wt']) ? $achieveMksWtArr[$cmId][$eventId][$subEventId][$subSubEventId][$subSubSubEventId]['wt'] : '--' !!}</span>
                                </td>
<!--                                <td class="text-{{$percentageTextAlign}} vcenter width-80">
                                ...
                                ?>
                                <td class="text-{{$totalMksTextAlign}} vcenter width-80">
                                    <span class="width-inherit bold">{!! !empty($cmInfo['total_term_mks']) ? Helper::numberFormat2Digit($cmInfo['total_term_mks']) : '--' !!}</span>
                                </td>
        ...
        <table class="no-border margin-top-10">
            ...
            <tr>
                <td class="no-border text-center" colspan="8">
                    <strong>{!!__('label.EVENT_RESULT_COMBINED')!!}</strong>
                </td>
            </tr>
        </table>
        <table class="no-border margin-top-10">
        ...
        <table class="table table-bordered table-hover table-head-fixer-color">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="vcenter">
                        @if(!empty($cmInfo['photo']) && File::exists('public/uploads/cm/' . $cmInfo['photo']))
                        <img width="50" height="60" src="public/uploads/cm/{{$cmInfo['photo']}}" alt="{{ Common::getFurnishedCmName($cmInfo['full_name']) }}">
                        @else
                        <img width="50" height="60" src="public/img/unknown.png" alt="{{ Common::getFurnishedCmName($cmInfo['full_name']) }}">
                        @endif
                    </td>
                    <?php
                    $totalMks = 0;
