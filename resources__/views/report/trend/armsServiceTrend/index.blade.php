...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        ...
        <div class="portlet-body">
            {!! Form::open(array('group' => 'form', 'url' => 'armsServiceTrendReport/filter','class' => 'form-horizontal', 'id' => 'submitForm')) !!}
            <div class="row">
                <div class="col-md-4">
...
<script type="text/javascript">
    ...
    $.ajax({
    url: "{{ URL::to('armsServiceTrendReport/getCourse')}}",
            type: "POST",
            dataType: "json",
            headers: {
    ...
    $.ajax({
    url: "{{ URL::to('armsServiceTrendReport/getArmsServiceEvent')}}",
            type: "POST",
            dataType: "json",
            headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
