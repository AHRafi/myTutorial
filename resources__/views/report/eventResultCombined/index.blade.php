...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        ...
        <div class="portlet-body">
            {!! Form::open(array('group' => 'form', 'url' => 'eventResultCombinedReport/filter','class' => 'form-horizontal', 'id' => 'submitForm')) !!}
            <div class="row">
                <div class="col-md-3">
...
<script type="text/javascript">
    $(function () {
        ...
        $(document).on("change", "#trainingYearId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('eventResultCombinedReport/getCourse')}}",
                type: "POST",
                dataType: "json",
                headers: {
        ...
        $(document).on("change", "#courseId", function () {
            ...
            if (courseId == 0) {
                $('#eventId').html("<option value='0'>@lang('label.ALL_EVENT')</option>");
                return false;
            }
            $.ajax({
                url: "{{ URL::to('eventResultCombinedReport/getEvent')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
