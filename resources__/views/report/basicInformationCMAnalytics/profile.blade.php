...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            ...
            <div class="actions">
                <a href="{{ URL::to('/nominalRollReport'.Helper::queryPageStr($qpArr)) }}" class="btn btn-sm blue-dark">
                ...
                <div class="col-md-2 text-center">
                    ...
                    <div class="profile-userpic">
                        ...
                        <img src="{{URL::to('/')}}/public/uploads/cm/{{$cmInfoData->photo}}" class="text-center img-responsive pic-bordered border-default recruit-profile-photo-full"
                             alt="{{ !empty($cmInfoData->cm_name)? $cmInfoData->cm_name:''}}" style="width: 100%;height: 100%;" />
                        @else 
