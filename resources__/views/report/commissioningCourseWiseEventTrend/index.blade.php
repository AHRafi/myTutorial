...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        ...
        <div class="portlet-body">
            {!! Form::open(array('group' => 'form', 'url' => 'commissioningCourseWiseEventTrendReport/filter','class' => 'form-horizontal', 'id' => 'submitForm')) !!}
            <div class="row">
                <div class="col-md-4">
...
if (!empty($selectedCommissioningCourses)) {
    foreach ($selectedCommissioningCourses as $commissioningCourseId => $wingCode) {
        ?>
            counter2 = 0;
            maxMinArr[counter1] = [];
        <?php
