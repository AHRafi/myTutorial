...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.MODERATION_MARKING_LIMIT_MENU')
            </div>
        </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $(document).on("change", "#courseId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('moderationMarkingLimit/getMarkingLimit')}}",
                type: "POST",
                dataType: "json",
                headers: {
        ...
        $(document).on('click', '.button-submit', function (e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url: "{{URL::to('moderationMarkingLimit/saveMarkingLimit')}}",
                        type: "POST",
                        datatype: 'json',
                        cache: false,
                        contentType: false,
                        ...
                        data: form_data,
                        success: function (res) {
                            toastr.success('@lang("label.MODERATION_MARKING_LIMIT_HAS_BEEN_ASSIGNED")', res, options);
