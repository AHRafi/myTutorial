                        ...
                        <div class = "row">
                            <div class = "col-md-3">
                                <ul class = "ver-inline-menu tabbable margin-bottom-10">
                                    <li class = "active">
                                        <a data-toggle = "tab" href = "#tab_2_1_1">
                                            <i class = "fa fa-user"></i> @lang('label.PERSONAL_INFO') </a>
                                    </li>
                                    <li class = "">
                                        <a data-toggle = "tab" href = "#tab_2_1_2">
                                            <i class = "fa fa-photo"></i> @lang('label.EDIT_PHOTO') </a>
                                    </li>
                                    <li class = "">
                            ...
                            <div class = "col-md-9">
                                <div class = "tab-content">
                                    <div id="tab_2_1_1"  class = "tab-pane active">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <span class="col-md-12 border-bottom-1-green-seagreen">
                                                    <strong>@lang('label.EDIT_PERSONAL_INFO')</strong>
                                                </span>
                                            </div>
                                        </div>
                                        {!! Form::open(['id' => 'editUserPersonalForm']) !!}
                                        {!! Form::hidden('user_basic_profile_id', $userInfoData['user_basic_profile_id']) !!}
                                        <div class="row margin-top-10">
                                            <div class="col-md-12">
                                                <div class="col-md-6 col-sm-6">
                                                    <div class = "form-group">
                                                        <label class = "control-label" for="personalNo">@lang('label.PERSONAL_NO') <span class="text-danger"> *</span></label>
                                                        {!! Form::text('personal_no', !empty($userInfoData['personal_no']) ? $userInfoData['personal_no'] : null, ['id'=> 'personalNo', 'class' => 'form-control']) !!}
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6">
                                                    <div class = "form-group">
                                                        <label class = "control-label" for="wingId">@lang('label.WING') <span class="text-danger"> *</span></label>
                                                        {!! Form::select('wing_id', $wingList, !empty($userInfoData['wing_id']) ? $userInfoData['wing_id'] : null, ['class' => 'form-control js-source-states', 'id' => 'wingId']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class = "form-group">
                                                        ...
                                                        {!! Form::textarea('full_name', !empty($userInfoData['full_name']) ? $userInfoData['full_name'] : null, ['id'=> 'fullName', 'class' => 'form-control full-name-text-area','cols'=>'20','rows' => '1']) !!}

                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6">
                                                    <div class = "form-group">
                                                        <label class = "control-label" for="rankId">@lang('label.RANK') <span class="text-danger"> *</span></label>
                                                        {!! Form::select('rank_id', $rankList, !empty($userInfoData['rank_id']) ? $userInfoData['rank_id'] : null, ['class' => 'form-control js-source-states', 'id' => 'rankId']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="col-md-6 col-sm-6">
                                                    <div class = "form-group">
                                                        <label class = "control-label" for="bnName">@lang('label.FULL_NAME_BANGLA') <span class="text-danger"> *</span></label>
                                                        {!! Form::text('bn_name', !empty($userInfoData['bn_name']) ? $userInfoData['bn_name'] : null, ['id'=> 'bnName', 'class' => 'form-control']) !!}
                                                    </div>
                                                </div>

                                                <div class="col-md-6 col-sm-6">
                                                    <div class = "form-group">
                                                        <label class = "control-label" for="armsServiceId">@lang('label.ARMS_SERVICE') <span class="text-danger"> *</span></label>
                                                        {!! Form::select('arms_service_id', $armsServiceList , !empty($userInfoData['arms_service_id']) ? $userInfoData['arms_service_id'] : null, ['class' => 'form-control js-source-states', 'id' => 'armsServiceId']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="col-md-6 col-sm-6">
                                                    <div class = "form-group">
                                                        ...
                                                        {!! Form::text('official_name', !empty($userInfoData['official_name']) ? $userInfoData['official_name'] : null, ['id'=> 'officialName', 'class' => 'form-control']) !!}
                                                    </div>
                                                </div>

                                                <div class="col-md-6 col-sm-6">
                                                    <div class = "form-group">
                                                        <label class = "control-label" for="number">@lang('label.PHONE_PERSONAL') <span class="text-danger"> *</span></label>
                                                        {!! Form::text('phone', !empty($userInfoData['phone']) ? $userInfoData['phone'] : null, ['id'=> 'number', 'class' => 'form-control']) !!}
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class = "form-group">
                                                        <label class = "control-label" for="email">@lang('label.EMAIL') <span class="text-danger"> *</span></label>
                                                        {!! Form::text('email', !empty($userInfoData['email']) ? $userInfoData['email'] : null, ['id'=> 'email', 'class' => 'form-control']) !!}
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6">
                                                    <div class = "form-group">
                                                        <label class = "control-label" for="number">@lang('label.PHONE_OFFICIAL') <span class="text-danger"> *</span></label>
                                                        {!! Form::text('phone_official', !empty($userInfoData['phone_official']) ? $userInfoData['phone_official'] : null, ['id'=> 'number', 'class' => 'form-control']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="col-md-6 col-sm-6">
                                                    <div class = "form-group">
                                                        ...
                                                        {!! Form::text('username', !empty($userInfoData['username']) ? $userInfoData['username'] : null, ['id'=> 'username', 'class' => 'form-control']) !!}
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class = "form-group">
                                                        ...
                                                        {!! Form::text('father_name', !empty($userInfoData['father_name']) ? $userInfoData['father_name'] : null, ['id'=> 'fatherName', 'class' => 'form-control']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row margin-top-10">
                                            <div class="col-md-12">
                                                <span class="col-md-12 border-bottom-1-green-seagreen">
                                                    <strong>@lang('label.COMMISSIONING_INFO')</strong>
                                                </span>
                                            </div>
                                        </div>
                                        <div class="row margin-top-10">
                                            <div class="col-md-12">
                                                <div class="col-md-6 col-sm-6">
                                                    <div class = "form-group">
                                                        <label class="control-label" for="commissioningCourseId">@lang('label.COMMISSIONING_COURSE') <span class="text-danger"> *</span></label>
                                                        {!! Form::select('commissioning_course_id', $comCourseList, !empty($userInfoData['commissioning_course_id']) ? $userInfoData['commissioning_course_id'] : null, ['class' => 'form-control js-source-states', 'id' => 'commissioningCourseId', 'autocomplete' => 'off']) !!}
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6">
                                                    <div class = "form-group">
                                                        <label class="control-label" for="commissionType">@lang('label.TYPE_OF_COMMISSION') <span class="text-danger"> *</span></label>
                                                        {!! Form::select('commission_type', $commissionTypeList, !empty($userInfoData['commissioning_type']) ? $userInfoData['commissioning_type'] : null, ['class' => 'form-control js-source-states', 'id' => 'commissionType', 'autocomplete' => 'off']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class = "form-group">
                                                        <label class = "control-label" for="commisioningDate">@lang('label.COMMISSIONING_DATE') <span class="text-danger"> *</span></label>
                                                        <div class="input-group date datepicker2">
                                                            {!! Form::text('commisioning_date', !empty($userInfoData['commisioning_date']) ? Helper::formatDate($userInfoData['commisioning_date']) : null, ['id'=> 'commisioningDate', 'class' => 'form-control', 'placeholder' => 'DD/MM/YYYY', 'readonly' => '']) !!}
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class = "form-group">
                                                        <label class = "control-label" for="anteDateSeniority">@lang('label.ANTE_DATE_SENIORITY') <span class="text-danger"> *</span></label>
                                                        {!! Form::text('ante_date_seniority', !empty($userInfoData['ante_date_seniority']) ? $userInfoData['ante_date_seniority'] : null, ['id'=> 'anteDateSeniority', 'class' => 'form-control']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row margin-top-10">
                                            <div class="col-md-12">
                                                <span class="col-md-12 border-bottom-1-green-seagreen">
                                                    <strong>@lang('label.BASIC_INFO')</strong>
                                                </span>
                                            </div>
                                        </div>
                                        <div class="row margin-top-10">
                                            <div class="col-md-12">
                                                <div class="col-md-6 col-sm-6">
                                                    <div class = "form-group">
                                                        <label class = "control-label" for="dob">@lang('label.DATE_OF_BIRTH') <span class="text-danger"> *</span></label>
                                                        <div class="input-group date datepicker2">
                                                            {!! Form::text('date_of_birth', !empty($userInfoData['date_of_birth']) ? Helper::formatDate($userInfoData['date_of_birth']) : null, ['id'=> 'dob', 'class' => 'form-control', 'placeholder' => 'DD/MM/YYYY', 'readonly' => '']) !!}
                                                            <span class="input-group-btn">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class = "form-group">
                                                        <label class = "control-label" for="birthPlace">@lang('label.BIRTH_PLACE') <span class="text-danger"> *</span></label>
                                                        {!! Form::text('birth_place', !empty($userInfoData['birth_place']) ? $userInfoData['birth_place'] : null, ['id'=> 'birthPlace', 'class' => 'form-control']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="col-md-6 col-sm-6">
                                                    <div class = "form-group">
                                                        <label class = "control-label" for="religionId">@lang('label.RELIGION') <span class="text-danger"> *</span></label>
                                                        {!! Form::select('religion_id', $religionList, !empty($userInfoData['religion_id']) ? $userInfoData['religion_id'] : null,  ['class' => 'form-control js-source-states', 'id' => 'religionId']) !!}
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6">
                                                    <label class="control-label" for="bloodGroup">@lang('label.BLOOD_GROUP') <span class="text-danger"> *</span></label>
                                                    {!! Form::select('blood_group', $bloodGroupList, !empty($userInfoData['blood_group']) ? $userInfoData['blood_group'] : null,  ['class' => 'form-control js-source-states', 'id' => 'bloodGroup']) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="col-md-6 col-sm-6">
                                                    <div class = "form-group">
                                                        <label class = "control-label" for="gender">@lang('label.GENDER') :</label>
                                                        @if(!empty($genderList))
                                                        <div class="md-radio-inline">
                                                            @foreach($genderList as $genderId => $gender)
                                                            <?php
                                                            $checked = $userInfoData['gender'] == $genderId ? true : ($genderId == '1' ? true : false);
                                                            ?>
                                                            <div class="md-radio">
                                        ...
                                        <div class="row margin-top-10">
                                            <div class = "col-md-12 margin-top-10 text-center">
                                                <a class = "btn  btn-circle green" id="editUserPersonalButton"> @lang('label.SAVE_CHANGES') </a>
                                    ...
                                    <!--Start Edit user Photo-->
                                    <div id="tab_2_1_2"  class = "tab-pane">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <span class="col-md-12 border-bottom-1-green-seagreen">
                                                    <strong>@lang('label.EDIT_PHOTO')</strong>
                                                </span>
                                            </div>
                                        </div>
                                        {!! Form::open(['id' => 'editUserPhotoForm', 'enctype' => 'multipart/form-data']) !!}
                                        {!! Form::hidden('user_basic_profile_id', $userInfoData->user_id) !!}
                                        <div class="row margin-top-10">
                                            <div class="col-md-12">
                                                <div class = "form-group">
                                                    <div class = "fileinput fileinput-new" data-provides = "fileinput">
                                                        <div class = "fileinput-new thumbnail">
                                                            <div class="profile-userpic">
                                                                @if(!empty($userInfoData->photo) && File::exists('public/uploads/user/' . $userInfoData->photo))
                                                                <img src="{{URL::to('/')}}/public/uploads/user/{{$userInfoData->photo}}" class="text-center img-responsive pic-bordered border-default recruit-profile-photo-full"
                                                                     alt="{{ !empty($userInfoData['official_name'])? $userInfoData['official_name']:''}}" style="width: 150px;height: auto;" />
                                                                @else
                                                                <img src="{{URL::to('/')}}/public/img/unknown.png" class="text-center img-responsive pic-bordered border border-default recruit-profile-photo-full"
                                                                     alt="{{ !empty($userInfoData->official_name)? $userInfoData->official_name:'' }}" style="width: 150px;height: auto;" />
                                                                @endif
                                            ...
                                            <div class = "col-md-12 margin-top-10">
                                                <a class = "btn  btn-circle green" id="editUserPhotoButton"> @lang('label.SAVE_CHANGES') </a>
                                                <a href = "{{ URL::to('user/'.$userInfoData->users_id.'/profile') }}" class = "btn  btn-circle default"> @lang('label.CANCEL') </a>
                                            </div>
                                        </div>
                                        {!! Form::close() !!}
                                                ...
                                                <div class = "col-md-12">
                                                    ...
                                                    <div class = "col-md-6 col-sm-6">
                                                        <div class = "form-group">
                                                            ...
                                                            {!! Form::select('spouse_occupation', $spouseProfession, null,  ['id'=> 'spouseOccupation', 'class' => 'form-control js-source-states']) !!}
                                                        </div>
                                                    </div>
                                                    <div class = "col-md-12">
                                                        <div class = "form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                <div class = "form-group margin-top-10">
                                                    ...
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        ...
                                                        @if(!empty($passportInfoData->pass_scan_copy))
                                                        <a href="{{URL::to('public/uploads/userPassport/'.$passportInfoData->pass_scan_copy)}}"
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <div class = "form-group">
                                                    ...
                                                    <div class = "col-md-12 fileinput fileinput-new" data-provides = "fileinput">
                                                        <div class = "fileinput-new thumbnail">
                                                            <div class="profile-userpic">
                                                                @if(!empty($passportInfoData->photo_without_uniform) && File::exists('public/uploads/userPassPhoto/' . $passportInfoData->photo_without_uniform))
                                                                <img src="{{URL::to('/')}}/public/uploads/userPassPhoto/{{$passportInfoData->photo_without_uniform}}" class="text-center img-responsive pic-bordered border-default recruit-profile-photo-full"
                                                                     alt="{{ !empty($userInfoData->official_name)? $userInfoData->official_name:''}}" style="width: 100px;height: auto;" />
                                                                @else
                                                                <img src="{{URL::to('/')}}/public/img/unknown.png" class="text-center img-responsive pic-bordered border border-default recruit-profile-photo-full"
                                                                     alt="{{ !empty($userInfoData->official_name)? $userInfoData->official_name:'' }}" style="width: 100px;height: auto;" />
                                                                @endif
...
<!--                                                                <td class="vcenter width-100">
                                                                    {!! Form::text('academic_qual['.$ceVar.'][from]', $civilEducation[$ceVar]['from'] ?? '', ['id'=> 'academicQualFrom'.$ceVar, 'class' => 'form-control width-full', 'placeholder' => 'DD/MM/YYYY']) !!}
                                                                </td>-->
                                                                <td class="vcenter width-100">
                                                                    {!! Form::text('academic_qual['.$ceVar.'][year]', $civilEducation[$ceVar]['to'] ?? '', ['id'=> 'academicQualTo'.$ceVar, 'class' => 'form-control width-full', 'placeholder' => 'YYYY']) !!}
                                                                </td>
...
<!--                                                                <td class="vcenter width-100">
                                                                    {!! Form::text('academic_qual['.$ceKey.'][from]', '', ['id'=> 'academicQualF<rom'.$ceKey, 'class' => 'form-control width-full', 'placeholder' => 'DD/MM/YYYY']) !!}
                                                                </td>-->
                                                                <td class="vcenter width-100">
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <div class="table-responsive webkit-scrollbar">
                                                                                        <table class="table table-bordered table-hover table-head-fixer-color">
                                                                                            <thead>
                                                                                                <tr class="info">
                                                                                                    <th scope="col" class="vcenter text-center width-50" rowspan="2">@lang('label.SERIAL')</th>
                                        ...
                                        <div class="row margin-top-10">
                                            <div class="col-md-6">
                                                <div class = "form-group">
                                                    ...
                                                    {!! Form::text('decoration', $decoration,  ['class' => 'form-control', 'id' => 'decoration']) !!}
                                                </div>
                                                <div class="clearfix">
                                                    <span class="label label-green-sharp">@lang('label.NOTE')</span>
                                                ...
                                                <!--                                                    {!! Form::text('hobby_id', $hobby,  ['class' => 'form-control', 'id' => 'hobby']) !!}-->
                                                <!--                                                </div>-->
    ...
    <script type = "text/javascript">
        $(function () {
            ...
            //START:: Photo
            $(document).on('click', '#editUserPhotoButton', function (e) {
                e.preventDefault();
                var formData = new FormData($('#editUserPhotoForm')[0]);
                $.ajax({
                    type: 'POST',
                    url: "{{ url('user/updatePhoto') }}",
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $(document).on('click', '#editUserPersonalButton', function (e) {
                e.preventDefault();
                var formData = new FormData($('#editUserPersonalForm')[0]);

                $.ajax({
                    type: 'POST',
                    url: "{{ url('user/updatePersonalInfo') }}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function (data) {
