...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        ...
        <div class="portlet-body">
            ...
            {!! Form::open(array('group' => 'form', 'url' => 'courseWiseDocReport/filter','class' => 'form-horizontal')) !!}
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-4">@lang('label.COURSE') </label>
                        <div class="col-md-8">
                            <div class="input-group">
                                {!! Form::select('course_id', $courseList  ,Request::get('course_id'), ['class' => 'form-control js-source-states', 'readonly' => '']) !!} 
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="td-actions vcenter text-center">
                                        <div class="width-inherit">
                                            ...
                                            {{ Form::open(array('url' => 'courseWiseDocReport/downloadFile', 'class' => 'download-file-form')) }}
