...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.CLASSIFICATION_WISE_DOC_REPORT')
            </div>
        </div>

        <div class="portlet-body">

            {!! Form::open(array('group' => 'form', 'url' => 'classificationWiseDocReport/filter','class' => 'form-horizontal')) !!}
            <div class="row">
                <div class="col-md-5">
                    <div class="form-group">
                        <label class="control-label col-md-5">@lang('label.CONTENT_CLASSIFICATION') </label>
                        <div class="col-md-7">
                            <div class="input-group">
                                {!! Form::select('classification_id', $contentClassificationList ,Request::get('classification_id'), ['class' => 'form-control js-source-states', 'readonly' => '']) !!} 
                            </div>
                ...
                <div class="col-md-12">
                    <div class="bg-blue-hoki bg-font-blue-hoki">
                        <h5 style="padding: 10px;">
                            ...
                            {{__('label.CONTENT_CLASSIFICATION')}} : <strong>{{ !empty(Request::get('classification_id')) && Request::get('classification_id') != 0 ? $contentClassificationList[Request::get('classification_id')] : __('label.N_A') }} |</strong>
                                ...
                                <tr>
                                    ...
                                    <td class="td-actions vcenter text-center">
                                        <div class="width-inherit">
                                            ...
                                            {{ Form::open(array('url' => 'classificationWiseDocReport/downloadFile', 'class' => 'download-file-form')) }}
