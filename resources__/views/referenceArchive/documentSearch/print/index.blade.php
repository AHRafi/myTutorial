            ...
            <div class="row margin-top-10">
                <div class="col-md-12">
                    <div class="text-center bold uppercase">
                        <span class="header">@lang('label.DOCUMENT_SEARCH_LIST')</span>
                    </div>
                </div>
            </div>
            <div class="row margin-top-10">
                            ...
                            <tr>
                                ...
                                <td class="vcenter width-200">
                                    <div class="width-inherit">
                                        ...
                                        <span class="bold"><i class="{{$target['content_classification_icon']}} font-{{$target['content_classification_color']}}"></i></span>
                                        @endif
                                    </div>
                                </td>
                                ...
                                <td class="vcenter text-center width-25">
                                    <span class="label label-sm label-green-steel bold">
                                ...
                                <td class="text-center vcenter">
                                    @if($target['status'] == '1')
                                    <span class="label label-sm label-green-sharp bold">@lang('label.ACTIVE')</span>
                                    @else
                                    <span class="label label-sm label-yellow bold">@lang('label.INACTIVE')</span>
                                    @endif
                                </td>
        ...
        <table class="no-border margin-top-10">
            ...
            <tr>
                <td class="no-border text-center" colspan="8">
                    <strong>{!!__('label.DOCUMENT_SEARCH_LIST')!!}</strong>
                </td>
            </tr>
        </table>
        <table class="no-border margin-top-10">
