...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.COURSE_WISE_DOC_REPORT')
            </div>
        </div>

        <div class="portlet-body">
            {!! Form::open(array('group' => 'form', 'url' => 'courseWiseDocSummary/filter','class' => 'form-horizontal')) !!}
            <div class="row">

                <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-4">@lang('label.COURSE')  <span class="text-danger">*</span></label>
                        <div class="col-md-8">
                            @if(Auth::user()->group_id != 4)
                                {!! Form::select('course[]', $courseList, $courseIds , ['multiple' => 'multiple', 'class' => 'form-control ', 'id' => 'course', 'data-width' => '100px']) !!}
                                <span class="text-danger">{{ $errors->first('course') }}</span>
                            @else
                                <div class="control-label pull-left"> <strong> {{$activeCourseInfo->name}} </strong></div>
                                {!! Form::hidden('course_id', $activeCourseInfo->id, ['id' => 'courseId']) !!}
                            @endif
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    numberDisplayed: 0,
            ...
            buttonWidth: 'inherit',
            maxHeight: 250,
            nonSelectedText: "@lang('label.SELECT_COURSE_OPT')",
