            ...
            <div class="row margin-top-10">
                <div class="col-md-12">
                    <div class="text-center bold uppercase">
                        <span class="header">@lang('label.DAILY_DOC_REPORT')</span>
                    </div>
                </div>
            </div>
            <div class="row margin-top-10">
        ...
        <table class="no-border margin-top-10">
            ...
            <tr>
                <td class="no-border text-center" colspan="8">
                    <strong>{!!__('label.DAILY_DOC_REPORT')!!}</strong>
                </td>
            </tr>
        </table>
        <table class="no-border margin-top-10">
        ...
        <table class="no-border margin-top-10">
            <tr>
                <td class="no-border" colspan="4">
                    @lang('label.GENERATED_ON') {!! '<strong>'.Helper::formatDate(date('Y-m-d H:i:s')).'</strong> by <strong>'. Common::getFurnishedCmName(Auth::user()->full_name).'</strong>' !!}.
                </td>
