...
<html lang="en">
    ...
    <head>
		...
		<link href="<?php echo e(asset('public/assets/title/title.css')); ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo e(asset('public/assets/pages/css/login2.min.css')); ?>" rel="stylesheet" type="text/css" />
...
<![endif]-->
        ...
        <script src="<?php echo e(asset('public/assets/pages/scripts/login.min.js')); ?>" type="text/javascript"></script>
		 <script src="<?php echo e(asset('public/js/login/particles.min.js')); ?>" type="text/javascript"></script>
       <!-- <script src="<?php echo e(asset('public/js/login/stats.min.js')); ?>" type="text/javascript"></script>-->
        <script src="<?php echo e(asset('public/js/login/particlesRun.min.js')); ?>" type="text/javascript"></script>
        <!-- END PAGE LEVEL SCRIPTS -->
        <!-- BEGIN THEME LAYOUT SCRIPTS -->
        <!-- END THEME LAYOUT SCRIPTS -->
    </body>

</html><?php /**PATH C:\xampp\htdocs\afwc\resources\views/layouts/login.blade.php ENDPATH**/ ?>