...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i><?php echo app('translator')->get('label.ORIGINATOR_WISE_DOC_REPORT'); ?>
            </div>
        </div>

        <div class="portlet-body">
            <?php echo Form::open(array('group' => 'form', 'url' => 'originatorWiseDocReport/filter','class' => 'form-horizontal')); ?>

            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-4"><?php echo app('translator')->get('label.ORIGINATOR'); ?> </label>
                        <div class="col-md-8">
                            <div class="input-group">
                                <?php echo Form::select('originator_id', $originatorList ,Request::get('originator_id'), ['class' => 'form-control js-source-states', 'id' => 'originator', 'readonly' => '']); ?> 
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="td-actions vcenter text-center">
                                        <div class="width-inherit">
                                            ...
                                            <?php echo e(Form::open(array('url' => 'originatorWiseDocReport/downloadFile', 'class' => 'download-file-form'))); ?>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\afwc\resources\views/referenceArchive/originatorWiseDocReport/index.blade.php ENDPATH**/ ?>