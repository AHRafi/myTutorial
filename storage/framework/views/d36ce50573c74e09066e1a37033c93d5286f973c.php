...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i><?php echo app('translator')->get('label.CAT_WISE_DOC_REPORT'); ?>
            </div>
        </div>

        <div class="portlet-body">
            <?php echo Form::open(array('group' => 'form', 'url' => 'catWiseDocReport/filter','class' => 'form-horizontal')); ?>

            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-4"><?php echo app('translator')->get('label.CATEGORY'); ?> </label>
                        <div class="col-md-8">
                            <div class="input-group">
                                <?php echo Form::select('category', $contentCategoryList ,Request::get('category'), ['class' => 'form-control js-source-states', 'id' => 'month', 'readonly' => '']); ?> 
                            </div>
                ...
                <div class="col-md-12">
                    <div class="bg-blue-hoki bg-font-blue-hoki">
                        <h5 style="padding: 10px;">
                            ...
                            <?php echo e(__('label.CATEGORY')); ?> : <strong><?php echo e(!empty(Request::get('category')) && Request::get('category') != 0 ? $contentCategoryList[Request::get('category')] : __('label.N_A')); ?> |</strong>
                                ...
                                <tr>
                                    ...
                                    <td class="td-actions vcenter text-center">
                                        <div class="width-inherit">
                                            ...
                                            <?php echo e(Form::open(array('url' => 'catWiseDocReport/downloadFile', 'class' => 'download-file-form'))); ?>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\afwc\resources\views/referenceArchive/catWiseDocReport/index.blade.php ENDPATH**/ ?>