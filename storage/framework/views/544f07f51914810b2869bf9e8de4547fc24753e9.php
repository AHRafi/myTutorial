...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i><?php echo app('translator')->get('label.CATEGORY_WISE_DOC_SUMMARY'); ?>
            </div>
        </div>

        <div class="portlet-body">
            <?php echo Form::open(array('group' => 'form', 'url' => 'catWiseDocSummary/filter','class' => 'form-horizontal')); ?>

            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-4"><?php echo app('translator')->get('label.CATEGORY'); ?> <span class="text-danger">*</span></label>
                        <div class="col-md-8">
                            <?php echo Form::select('category[]', $contentCategoryList, $categoryIds,  ['multiple' => 'multiple', 'class' => 'form-control', 'id' => 'categoryId', 'data-width' => '100px']); ?>
...
<script type="text/javascript">
    ...
    numberDisplayed: 0,
            ...
            buttonWidth: 'inherit',
            maxHeight: 250,
            nonSelectedText: "<?php echo app('translator')->get('label.SELECT_CATEGORY_OPT'); ?>",
...
?>
                    ...
                    title: {
                     <?php
                        if (sizeof($selectedCategories) > 1) {
                            ?>
                    text: "<?php echo app('translator')->get('label.CONTENT_CATEGORIES'); ?>",
                            <?php
                        }else{
                            ?>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\afwc\resources\views/referenceArchive/catWiseDocSummary/index.blade.php ENDPATH**/ ?>