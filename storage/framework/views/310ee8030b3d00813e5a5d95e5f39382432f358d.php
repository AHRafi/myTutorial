        ...
        <div class="row margin-top-20">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 tooltips" data-html=true>
                <a class=" term-marking-status tooltips" type=" button" data-placement="top"  data-toggle="modal"
                   data-rel="tooltip" course-id="<?php echo $courseId; ?>" term-id="<?php echo $termId; ?>"
                   data-original-title="<?php echo app('translator')->get('label.CLICK_HERE_TO_VIEW_TERM_STATUS_SUMMARY'); ?>" href="#termMarkingStatusSummaryModal">
...
<?php if($courseTotalCm != 0): ?>
<?php if(!empty($eventAssessmentCmList)): ?>
<?php if( sizeof($eventAssessmentCmList) == $courseTotalCm ): ?>
<div class="row">
            ...
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject bold uppercase font-dark font-size-14">
                        <?php echo app('translator')->get('label.CURRENT_COURSE_OVERALL_PERFORMANCE_PROGRESSIVE', ['course' => !empty($course->name)?$course->name.' ':'']); ?>
                    </span>
    ...
    <div class="col-md-6 col-sm-12 col-xs-12 margin-top-10">
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject bold uppercase font-dark font-size-14">
                        <?php echo app('translator')->get('label.CONTENT_SUMMARY'); ?>
                    </span>
                    <span class="caption-helper"></span>
                </div>
                <div class="actions">
                            ...
                            <table class="table table-hover table-head-fixer-color-grey-mint">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="vcenter"><?php echo app('translator')->get('label.AUTHORITY'); ?></th>
                                        <th class="vcenter text-center"><?php echo app('translator')->get('label.THIS_DAY'); ?></th>
                                        <th class="vcenter text-center"><?php echo app('translator')->get('label.THIS_MONTH'); ?></th>
                                        <th class="vcenter text-center"><?php echo app('translator')->get('label.THIS_COURSE'); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td class="vcenter text-center">1</td>
                                        <td class="vcenter"><?php echo app('translator')->get('label.DS'); ?></td>
                                        <td class="vcenter text-center">
                                            <span class="badge bold badge-green-seagreen"><?php echo !empty($contentArr['todays_total']['1']) ? $contentArr['todays_total']['1'] : 0; ?></span>
                                        </td>
                                        <td class="vcenter text-center">
                                            <span class="badge bold badge-yellow-casablanca"><?php echo !empty($contentArr['month_total']['1']) ? $contentArr['month_total']['1'] : 0; ?></span>
                                        </td>
                                        <td class="vcenter text-center">
                                            <span class="badge bold badge-purple-sharp"><?php echo !empty($contentArr['course_total']['1']) ? $contentArr['course_total']['1'] : 0; ?></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="vcenter text-center">2</td>
                                        <td class="vcenter"><?php echo app('translator')->get('label.CM'); ?></td>
                                        <td class="vcenter text-center">
                                            <span class="badge bold badge-green-seagreen"><?php echo !empty($contentArr['todays_total']['2']) ? $contentArr['todays_total']['2'] : 0; ?></span>
                                        </td>
                                        <td class="vcenter text-center">
                                            <span class="badge bold badge-yellow-casablanca"><?php echo !empty($contentArr['month_total']['2']) ? $contentArr['month_total']['2'] : 0; ?></span>
                                        </td>
                                        <td class="vcenter text-center">
                                            <span class="badge bold badge-purple-sharp"><?php echo !empty($contentArr['course_total']['2']) ? $contentArr['course_total']['2'] : 0; ?></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="vcenter text-center">3</td>
                                        <td class="vcenter"><?php echo app('translator')->get('label.STAFF'); ?></td>
                                        <td class="vcenter text-center">
                                            <span class="badge bold badge-green-seagreen"><?php echo !empty($contentArr['todays_total']['3']) ? $contentArr['todays_total']['3'] : 0; ?></span>
                                        </td>
                                        <td class="vcenter text-center">
                                            <span class="badge bold badge-yellow-casablanca"><?php echo !empty($contentArr['month_total']['3']) ? $contentArr['month_total']['3'] : 0; ?></span>
                                        </td>
                                        <td class="vcenter text-center">
                                            <span class="badge bold badge-purple-sharp"><?php echo !empty($contentArr['course_total']['3']) ? $contentArr['course_total']['3'] : 0; ?></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="vcenter text-right bold" colspan="2"><?php echo app('translator')->get('label.TOTAL'); ?></td>
                                        <td class="vcenter text-center bold">
                                            <span class="badge bold badge-green-seagreen"><?php echo !empty($contentArr['todays']['total']) ? $contentArr['todays']['total'] : 0; ?></span>
                                        </td>
                                        <td class="vcenter text-center bold">
                                            <span class="badge bold badge-yellow-casablanca"><?php echo !empty($contentArr['month']['total']) ? $contentArr['month']['total'] : 0; ?></span>
                                        </td>
                                        <td class="vcenter text-center bold">
                                            <span class="badge bold badge-purple-sharp"><?php echo !empty($contentArr['course']['total']) ? $contentArr['course']['total'] : 0; ?></span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
...
$.ajax({
url: "<?php echo e(URL::to('dashboard/requestCourseSatatusSummary')); ?>",
        type: "POST",
        datatype: 'json',
        headers: {
...
$.ajax({
url: "<?php echo e(URL::to('dashboard/getDsMarkingSummary')); ?>",
        type: "POST",
        datatype: 'json',
        headers: {
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
type: 'bar',
        ...
        series: [{
        name: "<?php echo app('translator')->get('label.NO_OF_CM'); ?>",
                data: [
<?php
...
?>
                ...
                title: {
                text: "<?php echo app('translator')->get('label.GRADES'); ?>",
                        style: {
                        color: undefined,
                                fontSize: '11px',
                                fontFamily: 'Helvetica, Arial, sans-serif',
...
?>
        ...
        yaxis: {
        title: {
        text: "<?php echo app('translator')->get('label.PERCENTAGE_OF_CM'); ?>",
                style: {
                color: undefined,
                        fontSize: '11px',
                        fontFamily: 'Helvetica, Arial, sans-serif',
...
</script><?php /**PATH C:\xampp\htdocs\afwc\resources\views/admin/commonFeatures/courseBlock.blade.php ENDPATH**/ ?>