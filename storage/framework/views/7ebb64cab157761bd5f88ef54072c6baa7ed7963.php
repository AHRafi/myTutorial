...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i><?php echo app('translator')->get('label.GS_TO_LESSON'); ?>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label col-md-5" for="gsId"><?php echo app('translator')->get('label.GS'); ?> :<span
                                        class="text-danger"> *</span></label>
                                <div class="col-md-7">
                                    <?php echo Form::select('gs_id', $gsList, Request::get('gs_id') ?? null, [
                    ...
                    <!--get module data-->
                    <div id="showLesson">
                        <?php if(!empty(Request::get('gs_id'))): ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <button class="label label-sm label-green-seagreen btn-label-groove tooltips"
                                        ...
                                        title="<?php echo app('translator')->get('label.SHOW_LESSON_ASSIGNED_TO_THIS_GS'); ?>">
                                    <?php echo app('translator')->get('label.TOTAL_NO_OF_LESSON_ASSIGNED_TO_THIS_GS'); ?>:&nbsp;<?php echo !empty($count) ? $count : 0; ?>&nbsp; <i
                        ...
                        <div class="row margin-top-10">
                            <div class="col-md-12 table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable">
                                    <thead>
                                        <tr>
                                            <th class="text-center vcenter " width="5%"><?php echo app('translator')->get('label.SL_NO'); ?>
                                            </th>
                        ...
                        <div class="form-actions">
                            <div class="col-md-offset-4 col-md-8">
                                ...
                                <a href="<?php echo e(URL::to('gsToLesson?gs_id=' . Request::get('gs_id'))); ?>"
...
<?php } ?>
        ...
        $(document).on("change", "#gsId", function () {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('gsToLesson/getLesson')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
        ...
        $(document).on('click', '.button-submit', function (e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url: "<?php echo e(URL::to('gsToLesson/saveGsToLesson')); ?>",
                        type: "POST",
                        datatype: 'json',
                        cache: false,
                        contentType: false,
        ...
        $(document).on("click", "#assignedLesson", function (e) {
            ...
            var gsId = $("#gsId").val();
            $.ajax({
                url: "<?php echo e(URL::to('gsToLesson/getAssignedLesson')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\afwc\resources\views/gsToLesson/index.blade.php ENDPATH**/ ?>