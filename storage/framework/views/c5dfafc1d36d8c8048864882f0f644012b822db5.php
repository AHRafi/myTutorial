...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i><?php echo app('translator')->get('label.RELATE_TERM_TO_SUB_SUB_SUB_EVENT'); ?>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label col-md-5" for="subSubEventId"><?php echo app('translator')->get('label.SUB_SUB_EVENT'); ?> :<span class="text-danger"> *</span></label>
                                <div class="col-md-7">
...
//
//            $.ajax({
//                url: "<?php echo e(URL::to('termToSubSubSubEvent/getTerm')); ?>",
//                type: "POST",
//                dataType: "json",
//                headers: {
...
//        });
        ...
        $(document).on("change", "#termId", function () {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('termToSubSubSubEvent/getEvent')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("change", "#eventId", function () {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('termToSubSubSubEvent/getSubEvent')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("change", "#subEventId", function () {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('termToSubSubSubEvent/getSubSubEvent')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("change", "#subSubEventId", function () {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('termToSubSubSubEvent/getSubSubSubEvent')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on('click', '.button-submit', function (e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url: "<?php echo e(URL::to('termToSubSubSubEvent/saveTermToSubSubSubEvent')); ?>",
                        type: "POST",
                        datatype: 'json',
                        cache: false,
                        contentType: false,
                        ...
                        data: form_data,
                        success: function (res) {
                            toastr.success('<?php echo app('translator')->get("label.SUB_SUB_SUB_EVENT_RELATED_WITH_TERM"); ?>', res, options);
        ...
        $(document).on('click', '#buttonDelete', function (e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        url: "<?php echo e(URL::to('termToSubSubSubEvent/deleteTermToSubSubSubEvent')); ?>",
                        type: "POST",
                        datatype: 'json',
                        cache: false,
                        contentType: false,
                        ...
                        success: function (res) {
                            toastr.success(res, '<?php echo app('translator')->get("label.SUB_SUB_SUB_EVENT_DELETED_SUCCESSFULLY"); ?>', options);
        ...
        $(document).on("click", "#assignedSubSubSubEvent", function (e) {
            ...
            var subSubEventId = $("#subSubEventId").val();
            $.ajax({
                url: "<?php echo e(URL::to('termToSubSubSubEvent/getAssignedSubSubSubEvent')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\afwc\resources\views/termToSubSubSubEvent/index.blade.php ENDPATH**/ ?>