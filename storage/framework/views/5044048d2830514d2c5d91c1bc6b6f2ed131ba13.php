...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i><?php echo app('translator')->get('label.BASIC_INFORMATION_WISE_DS_ANALYTICS'); ?>
            </div>
        </div>
        <div class="portlet-body">
            <!-- Begin Filter-->
            <?php echo Form::open(array('group' => 'form', 'url' => 'basicInfoWiseDsAnalytics/filter','class' => 'form-horizontal')); ?>
...
<!--                                    <td class="td-actions text-center vcenter">
    <div class="width-inherit">
        <a class="btn btn-xs green-seagreen tooltips vcenter" title="<?php echo app('translator')->get('label.CLICK_HERE_TO_VIEW_PROFILE'); ?>" href="<?php echo URL::to('basicInformationDSAnalytics/' . $target['id'] . '/profile'.Helper::queryPageStr($qpArr)); ?>">
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\afwc\resources\views/dsAnalytics/basicInfo/index.blade.php ENDPATH**/ ?>