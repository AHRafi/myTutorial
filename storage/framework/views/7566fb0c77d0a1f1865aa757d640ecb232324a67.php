...
<!-- new js -->
<script src="<?php echo e(asset('public/assets/global/plugins/amcharts4/core.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('public/assets/global/plugins/amcharts4/charts.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('public/assets/global/plugins/amcharts4/themes/animated.js')); ?>" type="text/javascript"></script>
<!-- End New Js -->
<script src="<?php echo e(asset('public/assets/global/plugins/amcharts/amcharts/serial.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('public/assets/global/plugins/amcharts4/export.min.js')); ?>" type="text/javascript"></script>
...
<script src="<?php echo e(asset('public/assets/pages/scripts/components-bootstrap-switch.min.js')); ?>" type="text/javascript"></script>
...
<script src="<?php echo e(asset('public/assets/pages/scripts/ui-extended-modals.min.js')); ?>" type="text/javascript"></script>
...
<script src="<?php echo e(asset('public/js/floating-scrollbar.js')); ?>" type="text/javascript"></script>
<!-- END:: JS FOR SCROLLBAR -->

<!-- START:: JS FOR GALLERY -->
<script src="<?php echo e(asset('public/assets/gallery/js/picturefill.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('public/assets/gallery/js/lightgallery.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('public/assets/gallery/js/lg-thumbnail.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('public/assets/gallery/js/lg-video.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('public/assets/gallery/js/lg-autoplay.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('public/assets/gallery/js/lg-zoom.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('public/assets/gallery/js/lg-hash.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('public/assets/gallery/js/lg-pager.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('public/assets/gallery/js/jquery.mousewheel.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('public/assets/gallery/js/nivo-lightbox.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('public/assets/gallery/js/album.js.download.js')); ?>" type="text/javascript"></script>
<!-- END:: JS FOR GALLERY -->




<?php /**PATH C:\xampp\htdocs\afwc\resources\views/layouts/default/footerScript.blade.php ENDPATH**/ ?>