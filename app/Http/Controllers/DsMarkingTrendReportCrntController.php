...
class DsMarkingTrendReportCrntController extends Controller {

    private $controller = 'DsMarkingTrendReportCrnt';
...
//            exit;
        ...
        return view('reportCrnt.dsMarkingTrend.index', compact('activeTrainingYearList', 'courseList'
...
//                        ->pluck('event.event_code', 'event.id')
//                        ->toArray();
//        $html2 = view('reportCrnt.dsMarkingTrend.getCourseWiseDs', compact('dsList'))->render();
//        $showEventView = view('reportCrnt.dsMarkingTrend.getCourseWiseEvent', compact('eventList'))->render();
        $html = view('reportCrnt.dsMarkingTrend.getCourse', compact('courseList'))->render();
    ...
    public function getTerm(Request $request) {
        ...
        $html1 = view('reportCrnt.armsServiceWiseEventTrend.getTerm', compact('termList'))->render();
    ...
    public function getCourseWiseDsEvent(Request $request) {
        ...
        $html = view('reportCrnt.dsMarkingTrend.getCourseWiseDs', compact('dsList'))->render();
        $showEventView = view('reportCrnt.dsMarkingTrend.getCourseWiseEvent', compact('eventList'))->render();
        return Response::json(['showEventView' => $showEventView, 'htm' => $html]);
    }
...
//        echo '<pre>';        print_r($subEventList); exit;
        ...
        $html = view('reportCrnt.dsMarkingTrend.getCourseWiseDs', compact('dsList'))->render();
        $showSubEventView = view('reportCrnt.dsMarkingTrend.getCourseWiseSubEvent', compact('subEventList'))->render();
...
//        echo '<pre>';        print_r($subEventList); exit;
        ...
        $html = view('reportCrnt.dsMarkingTrend.getCourseWiseDs', compact('dsList'))->render();
        $showSubSubEventView = view('reportCrnt.dsMarkingTrend.getCourseWiseSubSubEvent', compact('subSubEventList'))->render();
...
//        echo '<pre>';        print_r($subEventList); exit;
        ...
        $html = view('reportCrnt.dsMarkingTrend.getCourseWiseDs', compact('dsList'))->render();
        $showSubSubSubEventView = view('reportCrnt.dsMarkingTrend.getCourseWiseSubSubSubEvent', compact('subSubSubEventList'))->render();
...
//        $showSubSubSubEventView = view('reportCrnt.dsMarkingTrend.getCourseWiseSubSubSubEvent', compact('subSubSubEventList'))->render();
    ...
    public function filter(Request $request) {
        ...
        if ($validator->fails()) {
            return redirect('dsMarkingTrendReportCrnt?generate=false&' . $url)
                            ->withInput()
                            ->withErrors($validator);
        }
        return redirect('dsMarkingTrendReportCrnt?generate=true&' . $url);
    }
