...
class ArmsServiceWiseSubEventTrendReportCrntController extends Controller {

    private $controller = 'ArmsServiceWiseSubEventTrendReportCrnt';
...
//            exit;
        ...
        return view('reportCrnt.armsServiceWiseSubEventTrend.index', compact('activeTrainingYearList', 'courseList'
    ...
    public function getCourse(Request $request) {
        ...
        $html2 = view('reportCrnt.armsServiceWiseSubEventTrend.getCourseWiseArmsService', compact('armsServiceList'))->render();
        $showEventView = view('reportCrnt.armsServiceWiseSubEventTrend.getCourseWiseEvent', compact('eventList'))->render();
        $html = view('reportCrnt.armsServiceWiseSubEventTrend.getCourse', compact('courseList'))->render();
        $showSubEventView = view('reportCrnt.armsServiceWiseSubEventTrend.getSubEvent', compact('subEventList'))->render();
    ...
    public function getCourseWiseArmsServiceEvent(Request $request) {
        ...
        $html = view('reportCrnt.armsServiceWiseSubEventTrend.getCourseWiseArmsService', compact('armsServiceList'))->render();
        $showEventView = view('reportCrnt.armsServiceWiseSubEventTrend.getCourseWiseEvent', compact('eventList'))->render();
        $showSubEventView = view('reportCrnt.armsServiceWiseSubEventTrend.getSubEvent', compact('subEventList'))->render();
        return Response::json(['html' => $html, 'showEventView' => $showEventView, 'showSubEventView' => $showSubEventView]);
    }
    ...
    public function getSubEvent(Request $request) {
        ...
        $html = view('reportCrnt.armsServiceWiseSubEventTrend.getSubEvent', compact('subEventList'))->render();
    ...
    public function filter(Request $request) {
        ...
        if ($validator->fails()) {
            return redirect('armsServiceWiseSubEventTrendReportCrnt?generate=false&' . $url)
                            ->withInput()
                            ->withErrors($validator);
        }
        return redirect('armsServiceWiseSubEventTrendReportCrnt?generate=true&' . $url);
    }
