...
class ClassificationWiseDocReportController extends Controller {
    ...
    public function index(Request $request) {
        ...
        $archiveData['contentClassificationList'] = $contentClassificationList;
        ...
        if (!empty($qpArr['generate']) && $qpArr['generate'] == 'true') {
            ...
            if (!empty($qpArr['classification_id'])) {
                $contentArr = $contentArr->where('content.content_classification_id', $qpArr['classification_id']);
            }
