...
class ArmsServiceWiseEventTrendReportCrntController extends Controller {

    private $controller = 'ArmsServiceWiseEventTrendReportCrnt';
...
//            exit;
        ...
        return view('reportCrnt.armsServiceWiseEventTrend.index', compact('activeTrainingYearList', 'courseList', 'termList'
    ...
    public function getCourse(Request $request) {
        ...
        $html2 = view('reportCrnt.armsServiceWiseEventTrend.getCourseWiseArmsService', compact('armsServiceList'))->render();
        $showEventView = view('reportCrnt.armsServiceWiseEventTrend.getCourseWiseEvent', compact('eventList'))->render();
        $html = view('reportCrnt.armsServiceWiseEventTrend.getCourse', compact('courseList'))->render();
    ...
    public function getTerm(Request $request) {
        ...
        $eventList = [];
        $html1 = view('reportCrnt.armsServiceWiseEventTrend.getTerm', compact('termList'))->render();
        $html = view('reportCrnt.armsServiceWiseEventTrend.getCourseWiseArmsService', compact('armsServiceList'))->render();
        $showEventView = view('reportCrnt.armsServiceWiseEventTrend.getCourseWiseEvent', compact('eventList'))->render();
    ...
    public function filter(Request $request) {
        ...
        if ($validator->fails()) {
            return redirect('armsServiceWiseEventTrendReportCrnt?generate=false&' . $url)
                            ->withInput()
                            ->withErrors($validator);
        }
        return redirect('armsServiceWiseEventTrendReportCrnt?generate=true&' . $url);
    }
