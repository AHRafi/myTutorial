...
class OverallPerformanceTrendReportController extends Controller {

    private $controller = 'OverallPerformanceTrendReport';
    ...
    public function index(Request $request) {
        ...
        $eventMksWtArr = $eventWiseMksArr = $overallMksArr = $gradeList = [];
...
//            echo '<pre>';print_r($maxCm);exit;
        ...
        return view('report.overallPerformanceTrend.index', compact('activeTrainingYearList'
    ...
    public function getCourse(Request $request) {
        $courseList = ['0' => __('label.SELECT_COURSE_OPT')] + Course::where('training_year_id', $request->training_year_id)
                        ...
                        ->pluck('name', 'id')
                        ->toArray();
        $html = view('report.overallPerformanceTrend.getCourse', compact('courseList'))->render();
    ...
    public function filter(Request $request) {
        ...
        if ($validator->fails()) {
            return redirect('overallPerformanceTrendReport?generate=false&' . $url)
                            ->withInput()
                            ->withErrors($validator);
        }
        return redirect('overallPerformanceTrendReport?generate=true&' . $url);
    }
