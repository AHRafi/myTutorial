...
class MutualAssessmentSummaryReportController extends Controller {
    ...
    public function getSubEvent(Request $request) {
        ...
        $html2 = view('report.mutualAssessmentSummary.showSubSubEvent', compact('subSubEventList'))->render();
        $html3 = view('report.mutualAssessmentSummary.showSubSubSubEvent', compact('subSubSubEventList'))->render();

        $html1 = Self::getEventGroups($request);
        $html = view('report.mutualAssessmentSummary.showSubEvent', compact('subEventList'))->render();
    ...
    public function getSubSubEvent(Request $request) {
        ...
        $subSubSubEventList = ['0' => __('label.SELECT_SUB_SUB_SUB_EVENT_OPT')];
        $html2 = view('report.mutualAssessmentSummary.showSubSubSubEvent', compact('subSubSubEventList'))->render();


        $html1 = Self::getEventGroups($request);
        $html = view('report.mutualAssessmentSummary.showSubSubEvent', compact('subSubEventList'))->render();
    ...
    public function getSubSubSubEvent(Request $request) {
        ...
        $html1 = Self::getEventGroups($request);
        $html = view('report.mutualAssessmentSummary.showSubSubSubEvent', compact('subSubSubEventList'))->render();
    ...
    public function getEventGroups(Request $request) {
        ...
        $html = view('report.mutualAssessmentSummary.showEventGroup', compact('eventGroupList'))->render();
    ...
    public function getSynOrGp(Request $request) {
        ...
        $html1 = view('report.mutualAssessmentSummary.showSubEvent', compact('subEventList'))->render();
        $html2 = view('report.mutualAssessmentSummary.showSubSubEvent', compact('subSubEventList'))->render();
        $html3 = view('report.mutualAssessmentSummary.showSubSubSubEvent', compact('subSubSubEventList'))->render();
        $html4 = view('report.mutualAssessmentSummary.showEventGroup', compact('eventGroupList'))->render();

        $html = view('report.mutualAssessmentSummary.getSyn', compact('synList', 'subSynList', 'eventList', 'maProcess'))->render();
