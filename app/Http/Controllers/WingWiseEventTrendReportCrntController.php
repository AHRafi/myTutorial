...
class WingWiseEventTrendReportCrntController extends Controller {

    private $controller = 'WingWiseEventTrendReportCrnt';
    ...
    public function index(Request $request) {
        ...
        if (empty($activeTrainingYearList)) {
            $void['header'] = __('label.WING_WISE_EVENT_TREND');
        ...
        return view('reportCrnt.wingWiseEventTrend.index', compact('activeTrainingYearList', 'courseList'
    ...
    public function getCourse(Request $request) {
        ...
        $html2 = view('reportCrnt.wingWiseEventTrend.getCourseWiseWing', compact('wingList'))->render();
        $showEventView = view('reportCrnt.wingWiseEventTrend.getCourseWiseEvent', compact('eventList'))->render();
        $html = view('reportCrnt.wingWiseEventTrend.getCourse', compact('courseList'))->render();
        $html1 = view('reportCrnt.wingWiseEventTrend.getTerm', compact('termList'))->render();
    ...
    public function getTerm(Request $request) {
        ...
        $eventList = [];
        $html1 = view('reportCrnt.wingWiseEventTrend.getTerm', compact('termList'))->render();
        $html = view('reportCrnt.wingWiseEventTrend.getCourseWiseWing', compact('wingList'))->render();
        $showEventView = view('reportCrnt.wingWiseEventTrend.getCourseWiseEvent', compact('eventList'))->render();
    ...
    public function filter(Request $request) {
        ...
        if ($validator->fails()) {
            return redirect('wingWiseEventTrendReportCrnt?generate=false&' . $url)
                            ->withInput()
                            ->withErrors($validator);
        }
        return redirect('wingWiseEventTrendReportCrnt?generate=true&' . $url);
    }
