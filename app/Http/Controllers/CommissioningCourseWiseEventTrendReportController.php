...
class CommissioningCourseWiseEventTrendReportController extends Controller {

    private $controller = 'CommissioningCourseWiseEventTrendReport';
    ...
    public function index(Request $request) {
        ...
        return view('report.commissioningCourseWiseEventTrend.index', compact('activeTrainingYearList', 'courseList'
    ...
    public function getCourse(Request $request) {
        ...
        $html2 = view('report.commissioningCourseWiseEventTrend.getCourseWiseCommissioningCourse', compact('commissioningCourseList'))->render();
        $showEventView = view('report.commissioningCourseWiseEventTrend.getCourseWiseEvent', compact('eventList'))->render();
        $html = view('report.commissioningCourseWiseEventTrend.getCourse', compact('courseList'))->render();
        $html1 = view('report.commissioningCourseWiseEventTrend.getTerm', compact('termList'))->render();
    ...
    public function getTerm(Request $request) {
        ...
        $eventList = [];
        $html1 = view('report.commissioningCourseWiseEventTrend.getTerm', compact('termList'))->render();
        $html = view('report.commissioningCourseWiseEventTrend.getCourseWiseCommissioningCourse', compact('commissioningCourseList'))->render();
        $showEventView = view('report.commissioningCourseWiseEventTrend.getCourseWiseEvent', compact('eventList'))->render();
    ...
    public function filter(Request $request) {
        ...
        if ($validator->fails()) {
            return redirect('commissioningCourseWiseEventTrendReport?generate=false&' . $url)
                            ->withInput()
                            ->withErrors($validator);
        }
        return redirect('commissioningCourseWiseEventTrendReport?generate=true&' . $url);
    }
