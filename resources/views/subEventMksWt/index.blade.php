...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.SUB_EVENT_MKS_WT_DISTRIBUTION')
            </div>
        </div>
        ...
        <div class="portlet-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <!--get module data-->
                    <div id="showSubEventMksWt" class="col-md-offset-2 col-md-7"></div>
...
//
//            $.ajax({
//                url: "{{ URL::to('subEventMksWt/getEvent')}}",
//                type: "POST",
//                dataType: "json",
//                headers: {
...
//        });
        ...
        $(document).on("change", "#eventId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('subEventMksWt/getSubEventMksWt')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                ...
                success: function (res) {
                    $('#showSubEventMksWt').html(res.html);
                    $('.js-source-states').select2();
                    App.unblockUI();
                },
                error: function (jqXhr, ajaxOptions, thrownError) {
        ...
        $(document).on('click', '.button-submit', function (e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        url: "{{URL::to('subEventMksWt/saveSubEventMksWt')}}",
                        type: "POST",
                        datatype: 'json',
                        cache: false,
                        contentType: false,
        ...
        $(document).on('click', '#buttonDelete', function (e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        url: "{{URL::to('subEventMksWt/deleteSubEventMksWt')}}",
                        type: "POST",
                        datatype: 'json',
                        cache: false,
                        contentType: false,
