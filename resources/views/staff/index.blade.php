...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-user"></i>@lang('label.STAFF_LIST')
            </div>

            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('staff/create'.Helper::queryPageStr($qpArr)) }}"> @lang('label.CREATE_NEW_STAFF')
        ...
        <div class="portlet-body">
            <div id="filterOpt">
                <!-- Begin Filter-->
                {!! Form::open(array('group' => 'form', 'url' => 'staff/filter','class' => 'form-horizontal')) !!}
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center vcenter" width="50px">
                                <?php if (!empty($target->photo) && File::exists('public/uploads/staff/'.$target->photo)) { ?>
                                    <img width="50" height="60" src="{{URL::to('/')}}/public/uploads/staff/{{$target->photo}}" alt="{{ $target->full_name}}"/>
                                <?php } else { ?>
                            ...
                            <td class="td-actions text-center vcenter">
                                <div class="width-inherit">
                                    {!! Form::open(array('url' => 'staff/' . $target->id.'/'.Helper::queryPageStr($qpArr))) !!}
                                    ...
                                    @endif
                                    <a class="btn btn-xs btn-primary tooltips vcenter" title="Edit" href="{!! URL::to('staff/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) !!}">
