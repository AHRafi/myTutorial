...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.WARNING_WT_DISTRIBUTION')
            </div>
        </div>
        ...
        <div class="portlet-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <!--get module data-->
                    <div id="showWarningWt" class="col-md-offset-3 col-md-5"></div>
...
<script type="text/javascript">
    $(function () {
        $(document).on("change", "#courseId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('warningWt/getWarningWt')}}",
                type: "POST",
                dataType: "json",
                headers: {
        ...
        $(document).on('click', '.button-submit', function (e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        url: "{{URL::to('warningWt/saveWarningWt')}}",
                        type: "POST",
                        datatype: 'json',
                        cache: false,
                        contentType: false,
                        ...
                        data: form_data,
                        success: function (res) {
                            toastr.success(res, '@lang("label.WARNING_WT_HAS_BEEN_DISTRIBUTED_SUCCESSFULLY")', options);
