...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.EDIT_APPOINTMENT')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::model($target, ['route' => array('appointment.update', $target->id), 'method' => 'PATCH', 'files'=> true, 'class' => 'form-horizontal'] ) !!}
            ...
            <div class="form-body">
                <div class="row">
                    <div class="col-md-offset-1 col-md-7">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-4" for="responsibility">@lang('label.RESPONSIBILITY') :<span class="text-danger"> *</span></label>
                            <div class="col-md-8">
                                {!! Form::select('responsibility', $respList, Request::old('responsibility'), ['class' => 'form-control js-source-states', 'id' => 'responsibility']) !!} 
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-4 col-md-8">
                        ...
                        <a href="{{ URL::to('/appointment'.Helper::queryPageStr($qpArr)) }}" class="btn btn-circle btn-outline grey-salsa">@lang('label.CANCEL')</a>
                    </div>
                </div>
            </div>
            {!! Form::close() !!}
...
<script type="text/javascript">
    $(function () {
        ...
        $(document).on("change", "#serviceId", function () {
            ...
            $.ajax({
                url: "{{URL::to('appointment/getOrder')}}",
                data: {
