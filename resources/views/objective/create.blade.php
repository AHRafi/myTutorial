...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.CREATE_OBJECTIVE')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::open(array('group' => 'form', 'url' => 'objective', 'files'=> true, 'class' => 'form-horizontal')) !!}
                ...
                <div class="row">
                    <div class="col-md-offset-1 col-md-7">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::text('name',  null, ['id'=> 'name', 'class' => 'form-control', 'autocomplete' => 'off','placeholder' => __('label.NAME')]) !!}
                        ...
                        <div id="order">
                            <div class="form-group">
                                <label class="control-label col-md-4" for="lesson">@lang('label.LESSON') :<span class="text-danger"> *</span></label>
                                <div class="col-md-8">
                                    {!! Form::select('lesson_id', $lessonArr, null, ['class' => 'form-control js-source-states', 'id' => 'lesson']) !!}
