...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.SUB_SYN_LIST')
            </div>
            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('subSyndicate/create'.Helper::queryPageStr($qpArr)) }}"> @lang('label.CREATE_NEW_SUB_SYN')
        ...
        <div class="portlet-body">
            ...
            <div class="row">
                <!-- Begin Filter-->
                {!! Form::open(array('group' => 'form', 'url' => 'subSyndicate/filter','class' => 'form-horizontal')) !!}
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::text('fil_search',  Request::get('fil_search'), ['class' => 'form-control tooltips', 'id' => 'filSearch', 'title' => 'Name / Code', 'placeholder' => 'Name / Code', 'list' => 'subSyndicateName', 'autocomplete' => 'off']) !!} 
                                <datalist id="subSyndicateName">
                                    @if (!$nameArr->isEmpty())
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="td-actions vcenter text-center">
                                <div class="width-inherit">
                                    {{ Form::open(array('url' => 'subSyndicate/' . $target->id.Helper::queryPageStr($qpArr))) }}
                                    {{ Form::hidden('_method', 'DELETE') }}

                                    <a class="btn btn-xs btn-primary tooltips " title="Edit" href="{{ URL::to('subSyndicate/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">
                        ...
                        @else
                        <tr>
                            <td colspan="8" class="vcenter">@lang('label.NO_SUB_SYN_FOUND')</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
