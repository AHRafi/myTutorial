                                ...
                                <tr>
                                    ...
                                    <td class="td-actions text-center vcenter">
                                        <div class="width-inherit">
                                            <a class="btn btn-xs green-seagreen tooltips vcenter" title="@lang('label.CLICK_HERE_TO_VIEW_PROFILE')" href="{!! URL::to('individualProfileReport/' . $target->id . '/profile'.Helper::queryPageStr($qpArr)) !!}">
