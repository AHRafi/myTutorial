                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="vcenter text-center" width="36px">
                                    ...
                                    <img width="36px" height="40px" src="{{$basePath}}/public/uploads/cm/{{$cm['photo']}}" alt="{{ $cm['personal_no'] }}"/>
                                    @else
                                    <img width="36px" height="40px" src="{{$basePath}}/public/img/unknown.png" alt="{{ $cm['personal_no'] }}"/>
                                    @endif
                                </td>
                                ...
                                <td class="vcenter text-center" width="36px">
                                    ...
                                    <img width="36px" height="40px" src="{{$basePath}}/public/uploads/user/{{$ds['photo']}}" alt="{{ $ds['personal_no'] }}"/>
                                    @else
                                    <img width="36px" height="40px" src="{{$basePath}}/public/img/unknown.png" alt="{{ $ds['personal_no'] }}"/>
                                    @endif
                                </td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="vcenter">
                        ...
                        @foreach($cmArr[$markingGroupId] as $cmId => $cm)
                        <?php
                        $cmName = Common::getFurnishedCmName($cm['cm_name']);
                        ...
                        <div class="margin-bottom-2">
                            ...
                            if (!empty($cmPhoto && File::exists('public/uploads/cm/' . $cmPhoto))) {
                                ?>
                                <img width="22" height="25" src="{{URL::to('/')}}/public/uploads/cm/{{$cmPhoto}}" alt="{{ Common::getFurnishedCmName($cmName) }}"/>&nbsp;&nbsp;
                            <?php } else { ?>
                                <img width="22" height="25" src="{{URL::to('/')}}/public/img/unknown.png" alt="{{ Common::getFurnishedCmName($cmName) }}"/>&nbsp;&nbsp;
                                <?php
                            }
                            ?>  
                            {!!Common::getFurnishedCmName($cm['cm_name'])!!}
                        </div>
