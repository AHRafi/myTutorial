...
<script type="text/javascript">
    $(function () {
        ...
        $(document).on("change", "#termId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('mutualAssessmentSummaryReport/getSynOrGp')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("change", "#eventId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('mutualAssessmentSummaryReport/getSubEvent')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("change", "#subEventId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('mutualAssessmentSummaryReport/getSubSubEvent')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("change", "#subSubEventId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('mutualAssessmentSummaryReport/getSubSubSubEvent')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("change", "#subSubSubEventId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('mutualAssessmentSummaryReport/getEventGroup')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
