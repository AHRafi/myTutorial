...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.WING_WISE_PERFORMANCE_TREND')
            </div>
        </div>
        <div class="portlet-body">
            {!! Form::open(array('group' => 'form', 'url' => 'wingWisePerformanceTrendReport/filter','class' => 'form-horizontal', 'id' => 'submitForm')) !!}
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-md-8" id ="showWingView">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div id="wingWisePerformanceTrendChart" style="width: 100%; height: 400px; margin: 0 auto;"></div>
                </div>
                <div class="col-md-6">
...
//END:: Multiselect Wings

//START::Get Course
    $(document).on("change", "#trainingYearId", function () {
        var trainingYearId = $("#trainingYearId").val();
        $.ajax({
            url: "{{ URL::to('wingWisePerformanceTrendReport/getCourse')}}",
            type: "POST",
            dataType: "json",
            headers: {
            ...
            success: function (res) {
                ...
                $('#showWingView').html(res.showWingView);
...
//START::Get Course Wise Wing
    $(document).on("change", "#courseId", function () {
        var courseId = $("#courseId").val();
        $.ajax({
            url: "{{ URL::to('wingWisePerformanceTrendReport/getCourseWiseWing')}}",
            type: "POST",
            dataType: "json",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
//END::Get Course Wise Wing


//START :: Wing Wise Performance Trend Chart
...
?>
    ...
    var wingWisePerformanceTrendChart = new ApexCharts(document.querySelector("#wingWisePerformanceTrendChart"), wingWiseMksOptions);
    wingWisePerformanceTrendChart.render();
//END :: Wing Wise Performance Trend Chart
...
if (!empty($selectedWings)) {
    foreach ($selectedWings as $wingId => $wingCode) {
        ...
        if (!empty($gradeList)) {
            foreach ($gradeList as $gradeId => $gradeName) {
                $noOfCm = Helper::numberFormat2Digit(!empty($wingWiseMksPer[$gradeId][$wingId]) ? $wingWiseMksPer[$gradeId][$wingId] : 0);
                echo $noOfCm . ',';
            }
        }
        ?>
