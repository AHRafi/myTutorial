...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        ...
        <div class="portlet-body">
            <!-- Begin Filter-->
            {!! Form::open(array('group' => 'form', 'url' => 'cmCourseReport/filter','class' => 'form-horizontal')) !!}
            <div class="row">
                <div class="col-md-4">
                                ...
                                <tr>
                                    ...
                                    <td class="td-actions text-center vcenter">
                                        <div class="width-inherit">
                                            ...
                                            $courseName = !empty($courseList[Request::get('course_id')]) && Request::get('course_id') != 0 ? $courseList[Request::get('course_id')] : '';
                                            if (!empty($crReportList[$target['id']]) && file_exists('public/CourseReportFiles/' . $courseName . '/' . $crReportList[$target['id']])) {
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $(document).on("change", "#trainingYearId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('cmCourseReport/getCourse')}}",
                type: "POST",
                dataType: "json",
                headers: {
