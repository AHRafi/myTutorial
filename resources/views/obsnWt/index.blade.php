...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.OBSN_WT_DISTRIBUTION')
            </div>
        </div>
        ...
        <div class="portlet-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <!--get module data-->
                    <div id="showObsnWt" class="col-md-offset-3 col-md-6"></div>
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        ...
                        data: form_data,
                        success: function (res) {
                            toastr.success(res, '@lang("label.OBSN_WT_DISTRIBUTED_SUCCESSFULLY")', options);
