                ...
                <div class="details">
                    ...
                    <p> We can not find the page you're looking for.
                        ...
                        if (Auth::guest()) {
                            ...
                            ?>
                            <a href="{{URL::to('/')}}" style="color:black"> Return home </a></p>
                        <?php
                    } else {
                        //If LoggedIn, show "DASHBOARD" 
                        ?>
                        <a href="{{URL::to('dashboard')}}"style="color:black">{{ trans('label.DASHBOARD') }}</a></p>
                        <?php
                    }
                    ?>
                ...
                <div class="details">
                    <footer>
                        <div class="page-footer-inner">
                            &copy; {{date('Y')}} @lang('label.SINT_BANGLADESH_ARMY') | @lang('label.POWERED_BY')
                            <a target="_blank" href="http://www.swapnoloke.com/" style="color:black">@lang('label.SWAPNOLOKE')</a>
                        </div>
                    </footer>
                </div>
            </div>
