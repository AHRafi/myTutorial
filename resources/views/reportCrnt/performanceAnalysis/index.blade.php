...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.PERFORMANCE_ANALYSIS')
            </div>
        </div>
        <div class="portlet-body">
            {!! Form::open(array('group' => 'form', 'url' => 'performanceAnalysisReportCrnt/filter','class' => 'form-horizontal', 'id' => 'submitForm')) !!}
            <div class="row">
                <div class="col-md-2">
...
<script type="text/javascript">
    $(function () {
        ...
        $('#cmId').multiselect({
            ...
            buttonWidth: 'inherit',
            maxHeight: 250,
            nonSelectedText: "@lang('label.SELECT_CM')",
//        enableFiltering: true,
        ...
        $(document).on("change", "#trainingYearId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('performanceAnalysisReportCrnt/getCourse')}}",
                type: "POST",
                dataType: "json",
                headers: {
...
//        enableFiltering: true,
        ...
        $(document).on("change", "#courseId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('performanceAnalysisReportCrnt/getCm')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
