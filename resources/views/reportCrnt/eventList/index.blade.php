...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        ...
        <div class="portlet-body">
            <!-- Begin Filter-->
            {!! Form::open(array('group' => 'form', 'url' => 'eventListReportCrnt/filter','class' => 'form-horizontal')) !!}
            <div class="row">
                <div class="col-md-2">
                ...
                <div class="col-md-12">
                    <div class="bg-blue-hoki bg-font-blue-hoki">
                        <h5 style="padding: 10px;">
                            {{__('label.TRAINING_YEAR')}} : <strong>{{$activeTrainingYearInfo->name}} |</strong>
...
$(function () {
    ...
    $(document).on("change", "#trainingYearId", function () {
        ...
        $.ajax({
            url: "{{ URL::to('eventListReportCrnt/getCourse')}}",
            type: "POST",
            dataType: "json",
            headers: {
    ...
    $(document).on("change", "#courseId", function () {
        ...
        $.ajax({
            url: "{{ URL::to('eventListReportCrnt/getTerm')}}",
            type: "POST",
            dataType: "json",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
