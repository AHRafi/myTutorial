...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        ...
        <div class="portlet-body">
            {!! Form::open(array('group' => 'form', 'url' => 'wingWisePerformanceTrendReportCrnt/filter','class' => 'form-horizontal', 'id' => 'submitForm')) !!}
            <div class="row">
                <div class="col-md-2">
...
//START::Get Course
    $(document).on("change", "#trainingYearId", function () {
        ...
        $.ajax({
            url: "{{ URL::to('wingWisePerformanceTrendReportCrnt/getCourse')}}",
            type: "POST",
            dataType: "json",
            headers: {
...
//START::Get Course Wise Wing
    $(document).on("change", "#courseId", function () {
        ...
        $.ajax({
            url: "{{ URL::to('wingWisePerformanceTrendReportCrnt/getCourseWiseWing')}}",
            type: "POST",
            dataType: "json",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
