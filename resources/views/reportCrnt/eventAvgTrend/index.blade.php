...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        ...
        <div class="portlet-body">
            {!! Form::open(array('group' => 'form', 'url' => 'eventAvgTrendReportCrnt/filter','class' => 'form-horizontal', 'id' => 'submitForm')) !!}
            <div class="row">
                <div class="col-md-2">
...
$.ajax({
url: "{{ URL::to('eventAvgTrendReportCrnt/getCourse')}}",
        type: "POST",
        dataType: "json",
        headers: {
...
$.ajax({
url: "{{ URL::to('eventAvgTrendReportCrnt/getTerm')}}",
        type: "POST",
        dataType: "json",
        headers: {
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
$.ajax({
url: "{{ URL::to('eventAvgTrendReportCrnt/getCourseWiseEvent')}}",
        type: "POST",
        dataType: "json",
        headers: {
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
