...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.ARMS_SERVICE_WISE_PERFORMANCE_TREND')
            </div>
        </div>
        <div class="portlet-body">
            {!! Form::open(array('group' => 'form', 'url' => 'armsServiceWisePerformanceTrendReportCrnt/filter','class' => 'form-horizontal', 'id' => 'submitForm')) !!}
            <div class="row">
                <div class="col-md-2">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-md-8" id ="showArmsServiceView">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div id="armsServiceWisePerformanceTrendChart" style="width: 100%; height: 400px; margin: 0 auto;"></div>
                </div>
            </div>
...
//START::Get Course
    $(document).on("change", "#trainingYearId", function () {
        ...
        $.ajax({
            url: "{{ URL::to('armsServiceWisePerformanceTrendReportCrnt/getCourse')}}",
            type: "POST",
            dataType: "json",
            headers: {
            ...
            success: function (res) {
                ...
                $('#showArmsServiceView').html(res.showArmsServiceView);
...
//START::Get Course Wise Arms Service & Event
    $(document).on("change", "#courseId", function () {
        ...
        $.ajax({
            url: "{{ URL::to('armsServiceWisePerformanceTrendReportCrnt/getCourseWiseArmsService')}}",
            type: "POST",
            dataType: "json",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
//START :: Arms/Service Wise Performance Trend Chart
    ...
    foreach ($selectedArmsServices as $armsServiceId => $armsServiceCode) {
        ...
        if (!empty($gradeList)) {
            foreach ($gradeList as $gradeId => $gradeName) {
                $noOfCm = !empty($armsSvcWiseMksArr[$gradeId][$armsServiceId]) ? $armsSvcWiseMksArr[$gradeId][$armsServiceId] : 0;
                echo $noOfCm . ',';
            }
        }
        ?>
...
?>
    ...
    var armsServiceWisePerformanceTrendChart = new ApexCharts(document.querySelector("#armsServiceWisePerformanceTrendChart"), armsServiceWiseMksOptions);
    armsServiceWisePerformanceTrendChart.render();
//END :: Arms/Service Wise Performance Trend Chart
