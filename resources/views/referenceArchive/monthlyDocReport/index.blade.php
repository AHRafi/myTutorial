...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.MONTHLY_DOC_REPORT')
            </div>
        </div>

        <div class="portlet-body">
            {!! Form::open(array('group' => 'form', 'url' => 'monthlyDocReport/filter','class' => 'form-horizontal')) !!}
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-4">@lang('label.MONTH') </label>
                        <div class="col-md-8">
                            <div class="input-group">
                                {!! Form::select('month', $monthList ,Request::get('month'), ['class' => 'form-control js-source-states', 'id' => 'month', 'readonly' => '']) !!} 
                            </div>
                ...
                <div class="col-md-12">
                    <div class="bg-blue-hoki bg-font-blue-hoki">
                        <h5 style="padding: 10px;">
                            ...
                            {{__('label.MONTH')}} : <strong>{{ !empty(Request::get('month')) && Request::get('month') != 0 ? $monthList[Request::get('month')] : __('label.N_A') }} |</strong>
                                ...
                                <tr>
                                    ...
                                    <td class="td-actions vcenter text-center">
                                        <div class="width-inherit">
                                            ...
                                            {{ Form::open(array('url' => 'monthlyDocReport/downloadFile', 'class' => 'download-file-form')) }}
