...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.DAILY_DOC_REPORT')
            </div>
        </div>

        <div class="portlet-body">
            {!! Form::open(array('group' => 'form', 'url' => 'dailyDocReport/filter','class' => 'form-horizontal')) !!}
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group date datepicker2">
                                {!! Form::text('date_of_upload',Request::get('date_of_upload') ?? null, ['class' => 'form-control', 'id' => 'dateOfUpload', 'placeholder' => 'DD/MM/YYYY', 'readonly' => '']) !!} 
                ...
                <div class="col-md-12">
                    <div class="bg-blue-hoki bg-font-blue-hoki">
                        <h5 style="padding: 10px;">
                            ...
                            {{__('label.DATE_OF_UPLOAD')}} : <strong>{{ !empty(Request::get('date_of_upload')) && Request::get('date_of_upload') != '' ? Request::get('date_of_upload') : __('label.N_A') }} |</strong>
                                ...
                                <tr>
                                    ...
                                    <td class="td-actions vcenter text-center">
                                        <div class="width-inherit">
                                            ...
                                            {{ Form::open(array('url' => 'dailyDocReport/downloadFile', 'class' => 'download-file-form')) }}
