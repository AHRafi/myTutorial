...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.SUB_EVENT_LIST')
            </div>
            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('subEvent/create'.Helper::queryPageStr($qpArr)) }}"> @lang('label.CREATE_NEW_SUB_EVENT')
        ...
        <div class="portlet-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <!-- Begin Filter-->
                    {!! Form::open(array('group' => 'form', 'url' => 'subEvent/filter','class' => 'form-horizontal')) !!}
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    {!! Form::text('fil_search',  Request::get('fil_search'), ['class' => 'form-control tooltips', 'id' => 'filSearch', 'title' => 'Code', 'placeholder' => 'Code', 'list' => 'subEventCode', 'autocomplete' => 'off']) !!} 
                                    <datalist id="subEventCode">
                                        @if (!$nameArr->isEmpty())
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="vcenter">@lang('label.SUB_EVENT_CODE')</th>
                            <th class="vcenter">@lang('label.SUB_EVENT_DETAIL')</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="td-actions vcenter text-center">
                                <div class="width-inherit">
                                    {{ Form::open(array('url' => 'subEvent/' . $target->id.Helper::queryPageStr($qpArr))) }}
                                    {{ Form::hidden('_method', 'DELETE') }}

                                    <a class="btn btn-xs btn-primary tooltips " title="Edit" href="{{ URL::to('subEvent/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">
                        ...
                        @else
                        <tr>
                            <td colspan="7" class="vcenter">@lang('label.NO_SUB_EVENT_FOUND')</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
