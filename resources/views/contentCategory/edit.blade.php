...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-list"></i>@lang('label.EDIT_CONTENT_CATEGORY')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::model($target, ['route' => array('contentCategory.update', $target->id), 'method' => 'PATCH', 'class' => 'form-horizontal'] ) !!}
                    ...
                    <div class="col-md-offset-1 col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                {!! Form::select('related_compartment[]', $compartmentList, $comptArr, ['id' => 'relatedCompartment', 'class' => 'form-control mt-multiselect btn btn-default', 'multiple']) !!}
