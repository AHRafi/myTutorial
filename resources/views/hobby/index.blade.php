...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.HOBBY_LIST')
            </div>
            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('hobby/create'.Helper::queryPageStr($qpArr)) }}"> @lang('label.CREATE_NEW_HOBBY')
        ...
        <div class="portlet-body">
            ...
            <div class="row">
                <!-- Begin Filter-->
                {!! Form::open(array('group' => 'form', 'url' => 'hobby/filter','class' => 'form-horizontal')) !!}
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::text('fil_search',  Request::get('fil_search'), ['class' => 'form-control tooltips', 'id' => 'filSearch', 'title' => __('label.NAME').' / ' . __('label.SHORT_NAME'), 'placeholder' => __('label.NAME').' / ' . __('label.SHORT_NAME'), 'list' => 'hobbyName', 'autocomplete' => 'off']) !!} 
                                <datalist id="hobbyName">
                                    @if (!$nameArr->isEmpty())
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="td-actions text-center vcenter">
                                <div class="width-inherit">
                                    {{ Form::open(array('url' => 'hobby/' . $target->id.Helper::queryPageStr($qpArr))) }}
                                    {{ Form::hidden('_method', 'DELETE') }}

                                    <a class="btn btn-xs btn-primary tooltips " title="Edit" href="{{ URL::to('hobby/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">
                        ...
                        @else
                        <tr>
                            <td colspan="8" class="vcenter">@lang('label.NO_HOBBY_FOUND')</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
