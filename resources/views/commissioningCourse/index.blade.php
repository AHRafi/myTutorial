                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">@lang('label.SHORT_INFO')</th>
                            <th class="text-center vcenter">@lang('label.WING')</th>
                            <th class="text-center vcenter">@lang('label.COMMISSIONING_DATE')</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ $target->short_info }}</td>
                            <td class="text-center">{{ $target->wing }}</td>
                            <td class="text-center">{{ !empty($target->commissioning_date) ? Helper::formatDate($target->commissioning_date) : '' }}</td>
