...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.REC_SVC_INFORMATION_WISE_DS_ANALYTICS')
            </div>
        </div>

        <div class="portlet-body">
            <!-- Begin Filter-->
            {!! Form::open(array('group' => 'form', 'url' => 'recSvcWiseDsAnalytics/filter','class' => 'form-horizontal')) !!}
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-4" for="apptId">@lang('label.APPT_AFWC') </label>
                        <div class="col-md-8">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-4" for="unit">@lang('label.UNIT_FMN_INST')</label>
                        <div class="col-md-8">
                            {!! Form::text('unit',  Request::get('unit'), ['class' => 'form-control tooltips', 'id' => 'unit', 'placeholder' => __('label.UNIT_FMN_INST'), 'autocomplete' => 'off']) !!} 
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-4" for="responsibility">@lang('label.RESPONSIBILITY')</label>
                        <div class="col-md-8">
                            {!! Form::select('responsibility_id',  $svcResposibilityList,  Request::get('responsibility_id'), ['class' => 'form-control js-source-states', 'id' => 'responsibility','autocomplete' => 'off']) !!} 
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-4" for="responsibility">@lang('label.APPT')</label>
                        <div class="col-md-8">
                            {!! Form::text('appt',  Request::get('appt'), ['class' => 'form-control', 'id' => 'appt',  'placeholder' => 'Appt', 'autocomplete' => 'off']) !!} 
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="bg-blue-hoki bg-font-blue-hoki">
                        <h5 style="padding: 10px;">
                            ...
                            {{__('label.RESPONSIBILITY')}} : <strong>{{ !empty(Request::get('responsibility_id')) && Request::get('responsibility_id') != '' ? $svcResposibilityList[Request::get('responsibility_id')] : __('label.N_A') }} |</strong>
                        ...
                        <table class="table table-bordered table-hover table-head-fixer-color" id="dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="vcenter">{!! $svcResposibilityList[$rsInfo['responsibility']] ?? '' !!}</td>
