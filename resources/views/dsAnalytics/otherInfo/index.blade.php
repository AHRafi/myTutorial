...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.OTHER_INFORMATION_WISE_DS_ANALYTICS')
            </div>
        </div>
        <div class="portlet-body">
            <!-- Begin Filter-->
            {!! Form::open(array('group' => 'form', 'url' => 'otherInfoWiseDsAnalytics/filter','class' => 'form-horizontal')) !!}
            <div class="row">
                <div class="col-md-4">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {!! Form::text('extra_cur',  Request::get('extra_cur'), ['class' => 'form-control tooltips', 'placeholder' => 'Extra Curricular Expertise', 'autocomplete' => 'off']) !!} 
                        </div>
                    </div>
                </div>
