...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.PASSPORT_INFORMATION_WISE_DS_ANALYTICS')
            </div>
        </div>

        <div class="portlet-body">
            <!-- Begin Filter-->
            {!! Form::open(array('group' => 'form', 'url' => 'passportInfoWiseDsAnalytics/filter','class' => 'form-horizontal')) !!}
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {!! Form::text('name',  Request::get('name'), ['class' => 'form-control tooltips', 'id' => 'name', 'title' => 'Full Name/Official Name', 'placeholder' => 'Full Name/Official Name', 'list' => 'dsName', 'autocomplete' => 'off']) !!} 
                            <datalist id="dsName">
                                @if (!$nameArr->isEmpty())
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-4" for="armsService">@lang('label.APPT_AFWC') </label>
                        <div class="col-md-8">
                ...
                <div class="col-md-12">
                    <div class="bg-blue-hoki bg-font-blue-hoki">
                        <h5 style="padding: 10px;">
                            ...
                            {{__('label.APPOINTMENT_NAME')}} : <strong>{{ !empty(Request::get('appt_id')) && Request::get('appt_id') != 0 ? $appointmentList[Request::get('appt_id')] : __('label.N_A') }} |</strong>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="vcenter text-center">
                                        @if(!empty($target['pass_scan_copy']) && File::exists('public/uploads/userPassport/' . $target['pass_scan_copy']))
                                    ...
                                    <td class="vcenter text-center" width="35px">
                                        @if(!empty($target['photo_without_uniform']) && File::exists('public/uploads/userPassPhoto/' . $target['photo_without_uniform']))
                                        <img class="profile-zoom" width="35" height="50" src="{{URL::to('/')}}/public/uploads/userPassPhoto/{{$target['photo_without_uniform']}}" alt="{{$target['official_name']?? ''}}"/>
                                        @else
