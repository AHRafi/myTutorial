...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.CONSIDERATION_LIST')
            </div>
            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('considerations/create'.Helper::queryPageStr($qpArr)) }}"> @lang('label.CREATE_NEW_CONSIDERATION')
        ...
        <div class="portlet-body">
            ...
            <div class="row">
                <!-- Begin Filter-->
                {!! Form::open(array('group' => 'form', 'url' => 'considerations/filter','class' => 'form-horizontal')) !!}
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::text('fil_search',  Request::get('fil_search'), ['class' => 'form-control tooltips', 'id' => 'filSearch', 'title' => __('label.TITLE') , 'placeholder' => __('label.TITLE'), 'list' => 'considerationsName', 'autocomplete' => 'off']) !!} 
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                     ...
                     <tbody>
                        ...
                        <tr>
                            ...
                            <td class="td-actions text-center vcenter">
                                <div class="width-inherit">
                                    {{ Form::open(array('url' => 'considerations/' . $target->id.Helper::queryPageStr($qpArr))) }}
                                    {{ Form::hidden('_method', 'DELETE') }}

                                    <a class="btn btn-xs btn-primary tooltips " title="Edit" href="{{ URL::to('considerations/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">
                        ...
                        @else
                        <tr>
                            <td colspan="8" class="vcenter">@lang('label.NO_CONSIDERATION_FOUND')</td>
                        </tr>
                        @endif
                    </tbody>
