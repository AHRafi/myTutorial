...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.SUB_SUB_SUB_EVENT_MKS_WT_DISTRIBUTION')
            </div>
        </div>
        ...
        <div class="portlet-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <!--get module data-->
                    <div id="showSubSubSubEventMksWt" class="col-md-offset-2 col-md-7"></div>
...
//
//            $.ajax({
//                url: "{{ URL::to('subSubSubEventMksWt/getEvent')}}",
//                type: "POST",
//                dataType: "json",
//                headers: {
...
//        });
        ...
        $(document).on("change", "#eventId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('subSubSubEventMksWt/getSubEvent')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("change", "#subEventId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('subSubSubEventMksWt/getSubSubEvent')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("change", "#subSubEventId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('subSubSubEventMksWt/getSubSubSubEventMksWt')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                ...
                success: function (res) {
                    $('#showSubSubSubEventMksWt').html(res.html);
                    $('.js-source-states').select2();
                    App.unblockUI();
                },
                error: function (jqXhr, ajaxOptions, thrownError) {
        ...
        $(document).on('click', '.button-submit', function (e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        url: "{{URL::to('subSubSubEventMksWt/saveSubSubSubEventMksWt')}}",
                        type: "POST",
                        datatype: 'json',
                        cache: false,
                        contentType: false,
        ...
        $(document).on('click', '#buttonDelete', function (e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        url: "{{URL::to('subSubSubEventMksWt/deleteSubSubSubEventMksWt')}}",
                        type: "POST",
                        datatype: 'json',
                        cache: false,
                        contentType: false,
