...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        ...
        <div class="portlet-body">
            {!! Form::open(array('group' => 'form', 'url' => '#','class' => 'form-horizontal','id' => 'submitMAForm')) !!}
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-12">
                            <div class="alert alert-danger alert-dismissable">
                                <p><strong><i class="fa fa-bell-o fa-fw"></i> {!! __('label.NO_SUB_SYN_IS_ASSIGNED_TO_THIS_COURSE') !!}</strong></p>
                            </div>
                        </div>
                        @endif
                        @elseif($maProcess == '3')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    {!! Form::select('event_id', $eventsList, null, ['class' => 'form-control js-source-states', 'id' => 'eventId']) !!}
                                </div>
                            </div>
                        </div>
                        @else
                        ...
                        <div class="col-md-12">
                            <div class="alert alert-danger alert-dismissable">
                                <p><strong><i class="fa fa-bell-o fa-fw"></i> {!! __('label.MA_PROCESS_IS_NOT_SET_YET') !!}</strong></p>
                            </div>
                        </div>
                        @endif
...
//        });
        ...
        $(document).on("change", "#eventId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('mutualAssessment/getSubEvent')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("change", "#subEventId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('mutualAssessment/getSubSubEvent')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("change", "#subSubEventId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('mutualAssessment/getSubSubSubEvent')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("change", "#subSubSubEventId", function () {
            ...
            $.ajax({
                url: "{{ URL::to('mutualAssessment/getActDeact')}}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
