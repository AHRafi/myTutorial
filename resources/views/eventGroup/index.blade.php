...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.EVENT_GROUP_LIST')
            </div>
            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('eventGroup/create'.Helper::queryPageStr($qpArr)) }}"> @lang('label.CREATE_NEW_EVENT_GROUP')
        ...
        <div class="portlet-body">
            ...
            <div class="row">
                <!-- Begin Filter-->
                {!! Form::open(array('group' => 'form', 'url' => 'eventGroup/filter','class' => 'form-horizontal')) !!}
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::text('fil_search',  Request::get('fil_search'), ['class' => 'form-control tooltips', 'id' => 'filSearch', 'title' => __('label.NAME'), 'placeholder' => __('label.NAME'), 'list' => 'eventGroupName', 'autocomplete' => 'off']) !!} 
                                <datalist id="eventGroupName">
                                    @if (!$nameArr->isEmpty())
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="control-label col-md-4" for="hidden">@lang('label.SEARCH')</label>
                            <div class="col-md-8">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="td-actions text-center vcenter">
                                <div class="width-inherit">
                                    {{ Form::open(array('url' => 'eventGroup/' . $target->id.Helper::queryPageStr($qpArr))) }}
                                    {{ Form::hidden('_method', 'DELETE') }}

                                    <a class="btn btn-xs btn-primary tooltips " title="Edit" href="{{ URL::to('eventGroup/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">
                        ...
                        @else
                        <tr>
                            <td colspan="7" class="vcenter">@lang('label.NO_EVENT_GROUP_FOUND')</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
    ...
    $(function () {
        $(document).on('click', '.hide-show-btn', function (e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url: "{{URL::to('eventGroup/hideShow')}}",
                        type: "POST",
                        datatype: 'json',
                        headers: {
